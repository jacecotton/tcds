...
2.  **Icons**: Copies SVGs to `dist/images/icons` and generates a manifest.
3.  **Logos**: Copies files to `dist/images/logos`.
4.  **Tokens**: Runs `scripts/build-tokens.js` to generate token outputs in `dist/tokens`.
