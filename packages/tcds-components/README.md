...
```html
<tcds-tabs> <!-- custom element -->
  <tcds-tab>
    <h2 slot="title">Tab 1</h2> <!-- slot name -->
    <p>...</p>
  </tcds-tab>
  <tcds-tab selected> <!-- invented attribute -->
...
```html
<button class="tcds-button"> <!-- class name -->
  <tcds-icon icon="info"></tcds-icon> <!-- unclassed child -->
  View details
</button>
```
