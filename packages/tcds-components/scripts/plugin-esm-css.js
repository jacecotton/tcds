/**
 * This rollup plugin is a polyfill for ESM imports with CSS type attributes,
...
export default () => {
  return {
    ...
    // Step 1: Transform CSS import attributes into regular imports, so that
    ...
    async resolveId(importee, importer) {
      if (!importee.endsWith(".css") || !importer) return null;
