import {declarative, baseStyles, refreshProperties, html, slugify} from "@common/index.js";
import localStyles from "./accordion-section.css" with {type: "css"};
import animation from "@txch/tokens/dist/js/animation.js";

export default class TCDSAccordionSectionElement extends declarative(HTMLElement) {
  // #region Setup
