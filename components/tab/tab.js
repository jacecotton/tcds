...
var _Tab2;
var _initClass, _init_selected, _init_extra_selected;
...
var Tab = /*#__PURE__*/function (_Disclosure) {
  function Tab() {
    var _this;
    ...
    _init_extra_selected(_this);
    return _this;
  }
  _inherits(Tab, _Disclosure);
...
_Tab2 = Tab;
var _applyDecs2 = _applyDecs(_Tab2, [t("tcds-tab")], [[n({
  type: Boolean,
  reflect: true
}), 1, "selected"]], 0, void 0, Disclosure);
var _applyDecs2$e = _slicedToArray(_applyDecs2.e, 2);
_init_selected = _applyDecs2$e[0];
_init_extra_selected = _applyDecs2$e[1];
var _applyDecs2$c = _slicedToArray(_applyDecs2.c, 2);
_Tab = _applyDecs2$c[0];
