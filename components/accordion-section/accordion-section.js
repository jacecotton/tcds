...
_AccordionSection = AccordionSection;
var _applyDecs$e = _slicedToArray(_applyDecs(_AccordionSection, [], [[n({
  type: Boolean,
  reflect: true
}), 1, "open"]], 0, void 0, Disclosure).e, 2);
_init_open = _applyDecs$e[0];
_init_extra_open = _applyDecs$e[1];
