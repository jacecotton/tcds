...
function createLifecycleDecorator(lifecycleMethod) {
  return function (deps) {
    return function (target, propertyKey, descriptor) {
      ...
      if (!Object.prototype.hasOwnProperty.call(target.constructor, effectsKey)) {
        const parentEffects = target.constructor[effectsKey] || [];
        target.constructor[effectsKey] = [...parentEffects];
      }
