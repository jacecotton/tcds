...
const styles = i`body{background-color:var(--tcds-color-theme-background);color:var(--tcds-color-theme-text-primary);font-family:var(--tcds-font-family-body);font-size:var(--tcds-font-size-md);font-variant-numeric:lining-nums;font-variant-ligatures:none;margin:0;padding:0;overflow-wrap:break-word;overflow-x:hidden}@media(prefers-contrast: no-preference),(prefers-contrast: less){body{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}}button,input{touch-action:manipulation;-webkit-tap-highlight-color:rgba(0,0,0,0)}p{margin:1.5rem 0}:where(ul,ol){margin-top:0;margin-left:4ch;padding:0}:where(ul ul,ul ol,ol ul,ol ol){margin-left:2ch}:where(:not(li)>:is(ul,ol):not(:last-child)){margin-bottom:1rem}ul:where([role=list]),ol:where([role=list]){list-style:none;margin:0}:where(ol ol){list-style:upper-alpha}:where(ol ol ol){list-style:upper-roman}ol ::marker{font-family:var(--tcds-font-family-ui);font-weight:var(--tcds-font-weight-ui);color:rgba(0,0,0,.5);font-variant-numeric:lining-nums tabular-nums}:where(p,ol,ul,dl){line-height:var(--tcds-line-height-comfortable);color:inherit}:where(small,sub,sup){font-size:max(var(--tcds-font-size-xs),85%)}:where(sup){vertical-align:baseline;position:relative;top:-0.333lh}:where(a){color:var(--tcds-link-color);touch-action:manipulation;-webkit-tap-highlight-color:rgba(0,0,0,0)}:where(a:hover){color:var(--tcds-link-color-hover);text-decoration:none}:where(h1),:is(tcds-accordion,tcds-tabs) :where(h2){font:3rem/1.06 Fraunces,serif}@media(width >= 960px){:where(h1),:is(tcds-accordion,tcds-tabs) :where(h2){font:4.5rem/1.06 Fraunces,serif}}:where(h2),:is(tcds-accordion,tcds-tabs) :where(h3){font:2.625rem/1.06 Fraunces,serif}@media(width >= 960px){:where(h2),:is(tcds-accordion,tcds-tabs) :where(h3){font:3.75rem/1.06 Fraunces,serif}}:where(h3),:is(tcds-accordion,tcds-tabs) :where(h4){font:2.125rem/1.33 Fraunces,serif}@media(width >= 960px){:where(h3),:is(tcds-accordion,tcds-tabs) :where(h4){font:3rem/1.06 Fraunces,serif}}:where(h4),:is(tcds-accordion,tcds-tabs) :where(h5){font:1.25rem/1.33 Fraunces,serif}@media(width >= 960px){:where(h4),:is(tcds-accordion,tcds-tabs) :where(h5){font:2.625rem/1.33 Fraunces,serif}}:where(h1:not(:last-child)){margin-bottom:1em}:is(h2,h3,h4,h5,h6):where(:not(:first-child,[slot])){margin-top:2rem}:is(h2,h3,h4,h5,h6):where(:not(:last-child,[slot])){margin-bottom:2rem}:where(:not(h1,hr)+h2:not([slot])),:where(:not(h2,hr)+h3:not([slot])),:where(:not(h3,hr)+h4:not([slot])),:where(:not(h4,hr)+h5:not([slot])){margin-top:4rem}hr{border:none;border-top:1px solid var(--tcds-color-theme-edge);margin:1.5em 0}:where(audio,canvas,iframe,img,picture,svg,video){display:block;vertical-align:middle;max-width:100%}:where(:where(audio,canvas,iframe,img,picture,svg,video):not([height])){height:auto}:where(img,picture,svg,video){border:var(--tcds-media-border, 0);border-radius:var(--tcds-media-border-radius, 0);overflow:hidden}*{box-sizing:border-box;margin:0;padding:0}*::before,*::after{box-sizing:border-box}html{text-size-adjust:100%}@media(prefers-reduced-motion: no-preference){html{scroll-behavior:smooth}}[data-theme]{color:var(--tcds-color-theme-text-primary)}.text-accent{color:var(--tcds-color-theme-accent) !important}.tcds-icon,tcds-icon{display:inline-flex;vertical-align:middle;align-items:center}.tcds-icon::after,tcds-icon::after{content:"" !important;display:inline-block !important;height:1em !important;width:1em !important}.tcds-icon[preserve-color]::after,tcds-icon[preserve-color]::after{background-image:var(--tcds-icon) !important}.tcds-icon:not([preserve-color])::after,tcds-icon:not([preserve-color])::after{background:currentcolor !important;mask:var(--tcds-icon) no-repeat center !important}.bg-icon{position:relative;overflow:hidden;z-index:1}.bg-icon::before{content:"";display:block;position:absolute;top:0;left:0;width:100%;height:100%;background-color:var(--tcds-color-theme-faded);mask-image:var(--tcds-icon);mask-position:-15% center;mask-repeat:no-repeat;mask-size:200%;z-index:-1}@media(width >= 1312px){.bg-icon::before{mask-position:200% center;mask-size:85%}}.tcds-icon--facebook,.tcds-icon--facebook--brand,.bg-icon--facebook,.bg-icon--facebook--brand,tcds-icon[icon~=facebook],tcds-icon[icon~=facebook][category~=brand]{--tcds-icon: var(--tcds-icon-brand-facebook)}.tcds-icon--instagram,.tcds-icon--instagram--brand,.bg-icon--instagram,.bg-icon--instagram--brand,tcds-icon[icon~=instagram],tcds-icon[icon~=instagram][category~=brand]{--tcds-icon: var(--tcds-icon-brand-instagram)}.tcds-icon--mychart,.tcds-icon--mychart--brand,.bg-icon--mychart,.bg-icon--mychart--brand,tcds-icon[icon~=mychart],tcds-icon[icon~=mychart][category~=brand]{--tcds-icon: var(--tcds-icon-brand-mychart)}.tcds-icon--texans,.tcds-icon--texans--brand,.bg-icon--texans,.bg-icon--texans--brand,tcds-icon[icon~=texans],tcds-icon[icon~=texans][category~=brand]{--tcds-icon: var(--tcds-icon-brand-texans)}.tcds-icon--texas-childrens,.tcds-icon--texas-childrens--brand,.bg-icon--texas-childrens,.bg-icon--texas-childrens--brand,tcds-icon[icon~=texas-childrens],tcds-icon[icon~=texas-childrens][category~=brand]{--tcds-icon: var(--tcds-icon-brand-texas-childrens)}.tcds-icon--twitter,.tcds-icon--twitter--brand,.bg-icon--twitter,.bg-icon--twitter--brand,tcds-icon[icon~=twitter],tcds-icon[icon~=twitter][category~=brand]{--tcds-icon: var(--tcds-icon-brand-twitter)}.tcds-icon--youtube,.tcds-icon--youtube--brand,.bg-icon--youtube,.bg-icon--youtube--brand,tcds-icon[icon~=youtube],tcds-icon[icon~=youtube][category~=brand]{--tcds-icon: var(--tcds-icon-brand-youtube)}.tcds-icon--advocate,.tcds-icon--advocate--duotone,.bg-icon--advocate,.bg-icon--advocate--duotone,tcds-icon[icon~=advocate],tcds-icon[icon~=advocate][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-advocate)}.tcds-icon--areas-of-research,.tcds-icon--areas-of-research--duotone,.bg-icon--areas-of-research,.bg-icon--areas-of-research--duotone,tcds-icon[icon~=areas-of-research],tcds-icon[icon~=areas-of-research][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-areas-of-research)}.tcds-icon--baby-boy,.tcds-icon--baby-boy--duotone,.bg-icon--baby-boy,.bg-icon--baby-boy--duotone,tcds-icon[icon~=baby-boy],tcds-icon[icon~=baby-boy][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-baby-boy)}.tcds-icon--baby-hands,.tcds-icon--baby-hands--duotone,.bg-icon--baby-hands,.bg-icon--baby-hands--duotone,tcds-icon[icon~=baby-hands],tcds-icon[icon~=baby-hands][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-baby-hands)}.tcds-icon--baby-stork,.tcds-icon--baby-stork--duotone,.bg-icon--baby-stork,.bg-icon--baby-stork--duotone,tcds-icon[icon~=baby-stork],tcds-icon[icon~=baby-stork][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-baby-stork)}.tcds-icon--badge-heart,.tcds-icon--badge-heart--duotone,.bg-icon--badge-heart,.bg-icon--badge-heart--duotone,tcds-icon[icon~=badge-heart],tcds-icon[icon~=badge-heart][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-badge-heart)}.tcds-icon--caduceus,.tcds-icon--caduceus--duotone,.bg-icon--caduceus,.bg-icon--caduceus--duotone,tcds-icon[icon~=caduceus],tcds-icon[icon~=caduceus][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-caduceus)}.tcds-icon--calendar-edit,.tcds-icon--calendar-edit--duotone,.bg-icon--calendar-edit,.bg-icon--calendar-edit--duotone,tcds-icon[icon~=calendar-edit],tcds-icon[icon~=calendar-edit][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-calendar-edit)}.tcds-icon--calendar-star,.tcds-icon--calendar-star--duotone,.bg-icon--calendar-star,.bg-icon--calendar-star--duotone,tcds-icon[icon~=calendar-star],tcds-icon[icon~=calendar-star][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-calendar-star)}.tcds-icon--chat-people,.tcds-icon--chat-people--duotone,.bg-icon--chat-people,.bg-icon--chat-people--duotone,tcds-icon[icon~=chat-people],tcds-icon[icon~=chat-people][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-chat-people)}.tcds-icon--earth-star,.tcds-icon--earth-star--duotone,.bg-icon--earth-star,.bg-icon--earth-star--duotone,tcds-icon[icon~=earth-star],tcds-icon[icon~=earth-star][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-earth-star)}.tcds-icon--earth,.tcds-icon--earth--duotone,.bg-icon--earth,.bg-icon--earth--duotone,tcds-icon[icon~=earth],tcds-icon[icon~=earth][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-earth)}.tcds-icon--family-add-member,.tcds-icon--family-add-member--duotone,.bg-icon--family-add-member,.bg-icon--family-add-member--duotone,tcds-icon[icon~=family-add-member],tcds-icon[icon~=family-add-member][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-family-add-member)}.tcds-icon--find-clinical-trials,.tcds-icon--find-clinical-trials--duotone,.bg-icon--find-clinical-trials,.bg-icon--find-clinical-trials--duotone,tcds-icon[icon~=find-clinical-trials],tcds-icon[icon~=find-clinical-trials][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-find-clinical-trials)}.tcds-icon--first-aid,.tcds-icon--first-aid--duotone,.bg-icon--first-aid,.bg-icon--first-aid--duotone,tcds-icon[icon~=first-aid],tcds-icon[icon~=first-aid][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-first-aid)}.tcds-icon--flask,.tcds-icon--flask--duotone,.bg-icon--flask,.bg-icon--flask--duotone,tcds-icon[icon~=flask],tcds-icon[icon~=flask][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-flask)}.tcds-icon--giving,.tcds-icon--giving--duotone,.bg-icon--giving,.bg-icon--giving--duotone,tcds-icon[icon~=giving],tcds-icon[icon~=giving][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-giving)}.tcds-icon--hands-heart,.tcds-icon--hands-heart--duotone,.bg-icon--hands-heart,.bg-icon--hands-heart--duotone,tcds-icon[icon~=hands-heart],tcds-icon[icon~=hands-heart][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-hands-heart)}.tcds-icon--heartbeat,.tcds-icon--heartbeat--duotone,.bg-icon--heartbeat,.bg-icon--heartbeat--duotone,tcds-icon[icon~=heartbeat],tcds-icon[icon~=heartbeat][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-heartbeat)}.tcds-icon--laptop-check,.tcds-icon--laptop-check--duotone,.bg-icon--laptop-check,.bg-icon--laptop-check--duotone,tcds-icon[icon~=laptop-check],tcds-icon[icon~=laptop-check][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-laptop-check)}.tcds-icon--laptop-heart,.tcds-icon--laptop-heart--duotone,.bg-icon--laptop-heart,.bg-icon--laptop-heart--duotone,tcds-icon[icon~=laptop-heart],tcds-icon[icon~=laptop-heart][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-laptop-heart)}.tcds-icon--laptop-plus,.tcds-icon--laptop-plus--duotone,.bg-icon--laptop-plus,.bg-icon--laptop-plus--duotone,tcds-icon[icon~=laptop-plus],tcds-icon[icon~=laptop-plus][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-laptop-plus)}.tcds-icon--like-plus,.tcds-icon--like-plus--duotone,.bg-icon--like-plus,.bg-icon--like-plus--duotone,tcds-icon[icon~=like-plus],tcds-icon[icon~=like-plus][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-like-plus)}.tcds-icon--location-pin-1,.tcds-icon--location-pin-1--duotone,.bg-icon--location-pin-1,.bg-icon--location-pin-1--duotone,tcds-icon[icon~=location-pin-1],tcds-icon[icon~=location-pin-1][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-location-pin-1)}.tcds-icon--location-pin-plus,.tcds-icon--location-pin-plus--duotone,.bg-icon--location-pin-plus,.bg-icon--location-pin-plus--duotone,tcds-icon[icon~=location-pin-plus],tcds-icon[icon~=location-pin-plus][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-location-pin-plus)}.tcds-icon--map-search,.tcds-icon--map-search--duotone,.bg-icon--map-search,.bg-icon--map-search--duotone,tcds-icon[icon~=map-search],tcds-icon[icon~=map-search][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-map-search)}.tcds-icon--person-woman,.tcds-icon--person-woman--duotone,.bg-icon--person-woman,.bg-icon--person-woman--duotone,tcds-icon[icon~=person-woman],tcds-icon[icon~=person-woman][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-person-woman)}.tcds-icon--personnel-doctor-man-plus,.tcds-icon--personnel-doctor-man-plus--duotone,.bg-icon--personnel-doctor-man-plus,.bg-icon--personnel-doctor-man-plus--duotone,tcds-icon[icon~=personnel-doctor-man-plus],tcds-icon[icon~=personnel-doctor-man-plus][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-personnel-doctor-man-plus)}.tcds-icon--personnel-man-plus,.tcds-icon--personnel-man-plus--duotone,.bg-icon--personnel-man-plus,.bg-icon--personnel-man-plus--duotone,tcds-icon[icon~=personnel-man-plus],tcds-icon[icon~=personnel-man-plus][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-personnel-man-plus)}.tcds-icon--personnel-nurse-plus,.tcds-icon--personnel-nurse-plus--duotone,.bg-icon--personnel-nurse-plus,.bg-icon--personnel-nurse-plus--duotone,tcds-icon[icon~=personnel-nurse-plus],tcds-icon[icon~=personnel-nurse-plus][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-personnel-nurse-plus)}.tcds-icon--professions-doctor-man,.tcds-icon--professions-doctor-man--duotone,.bg-icon--professions-doctor-man,.bg-icon--professions-doctor-man--duotone,tcds-icon[icon~=professions-doctor-man],tcds-icon[icon~=professions-doctor-man][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-professions-doctor-man)}.tcds-icon--professions-doctor-woman,.tcds-icon--professions-doctor-woman--duotone,.bg-icon--professions-doctor-woman,.bg-icon--professions-doctor-woman--duotone,tcds-icon[icon~=professions-doctor-woman],tcds-icon[icon~=professions-doctor-woman][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-professions-doctor-woman)}.tcds-icon--search-man,.tcds-icon--search-man--duotone,.bg-icon--search-man,.bg-icon--search-man--duotone,tcds-icon[icon~=search-man],tcds-icon[icon~=search-man][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-search-man)}.tcds-icon--search-square,.tcds-icon--search-square--duotone,.bg-icon--search-square,.bg-icon--search-square--duotone,tcds-icon[icon~=search-square],tcds-icon[icon~=search-square][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-search-square)}.tcds-icon--search-woman,.tcds-icon--search-woman--duotone,.bg-icon--search-woman,.bg-icon--search-woman--duotone,tcds-icon[icon~=search-woman],tcds-icon[icon~=search-woman][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-search-woman)}.tcds-icon--search,.tcds-icon--search--duotone,.bg-icon--search,.bg-icon--search--duotone,tcds-icon[icon~=search],tcds-icon[icon~=search][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-search)}.tcds-icon--sections,.tcds-icon--sections--duotone,.bg-icon--sections,.bg-icon--sections--duotone,tcds-icon[icon~=sections],tcds-icon[icon~=sections][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-sections)}.tcds-icon--tablet-hand-plus,.tcds-icon--tablet-hand-plus--duotone,.bg-icon--tablet-hand-plus,.bg-icon--tablet-hand-plus--duotone,tcds-icon[icon~=tablet-hand-plus],tcds-icon[icon~=tablet-hand-plus][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-tablet-hand-plus)}.tcds-icon--test-tubes,.tcds-icon--test-tubes--duotone,.bg-icon--test-tubes,.bg-icon--test-tubes--duotone,tcds-icon[icon~=test-tubes],tcds-icon[icon~=test-tubes][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-test-tubes)}.tcds-icon--todo-check,.tcds-icon--todo-check--duotone,.bg-icon--todo-check,.bg-icon--todo-check--duotone,tcds-icon[icon~=todo-check],tcds-icon[icon~=todo-check][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-todo-check)}.tcds-icon--todo-heart,.tcds-icon--todo-heart--duotone,.bg-icon--todo-heart,.bg-icon--todo-heart--duotone,tcds-icon[icon~=todo-heart],tcds-icon[icon~=todo-heart][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-todo-heart)}.tcds-icon--trolley-woman,.tcds-icon--trolley-woman--duotone,.bg-icon--trolley-woman,.bg-icon--trolley-woman--duotone,tcds-icon[icon~=trolley-woman],tcds-icon[icon~=trolley-woman][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-trolley-woman)}.tcds-icon--trolley,.tcds-icon--trolley--duotone,.bg-icon--trolley,.bg-icon--trolley--duotone,tcds-icon[icon~=trolley],tcds-icon[icon~=trolley][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-trolley)}.tcds-icon--vegetable-apple,.tcds-icon--vegetable-apple--duotone,.bg-icon--vegetable-apple,.bg-icon--vegetable-apple--duotone,tcds-icon[icon~=vegetable-apple],tcds-icon[icon~=vegetable-apple][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-vegetable-apple)}.tcds-icon--vegetable-beet,.tcds-icon--vegetable-beet--duotone,.bg-icon--vegetable-beet,.bg-icon--vegetable-beet--duotone,tcds-icon[icon~=vegetable-beet],tcds-icon[icon~=vegetable-beet][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-vegetable-beet)}.tcds-icon--virtual-meeting-man,.tcds-icon--virtual-meeting-man--duotone,.bg-icon--virtual-meeting-man,.bg-icon--virtual-meeting-man--duotone,tcds-icon[icon~=virtual-meeting-man],tcds-icon[icon~=virtual-meeting-man][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-virtual-meeting-man)}.tcds-icon--world-laboratories,.tcds-icon--world-laboratories--duotone,.bg-icon--world-laboratories,.bg-icon--world-laboratories--duotone,tcds-icon[icon~=world-laboratories],tcds-icon[icon~=world-laboratories][category~=duotone]{--tcds-icon: var(--tcds-icon-duotone-world-laboratories)}.tcds-icon--ambulance,.tcds-icon--ambulance--primary,.bg-icon--ambulance,.bg-icon--ambulance--primary,tcds-icon[icon~=ambulance],tcds-icon[icon~=ambulance][category~=primary]{--tcds-icon: var(--tcds-icon-primary-ambulance)}.tcds-icon--annual-checkup,.tcds-icon--annual-checkup--primary,.bg-icon--annual-checkup,.bg-icon--annual-checkup--primary,tcds-icon[icon~=annual-checkup],tcds-icon[icon~=annual-checkup][category~=primary]{--tcds-icon: var(--tcds-icon-primary-annual-checkup)}.tcds-icon--appointment,.tcds-icon--appointment--primary,.bg-icon--appointment,.bg-icon--appointment--primary,tcds-icon[icon~=appointment],tcds-icon[icon~=appointment][category~=primary]{--tcds-icon: var(--tcds-icon-primary-appointment)}.tcds-icon--ask-a-doctor,.tcds-icon--ask-a-doctor--primary,.bg-icon--ask-a-doctor,.bg-icon--ask-a-doctor--primary,tcds-icon[icon~=ask-a-doctor],tcds-icon[icon~=ask-a-doctor][category~=primary]{--tcds-icon: var(--tcds-icon-primary-ask-a-doctor)}.tcds-icon--blood-pressure,.tcds-icon--blood-pressure--primary,.bg-icon--blood-pressure,.bg-icon--blood-pressure--primary,tcds-icon[icon~=blood-pressure],tcds-icon[icon~=blood-pressure][category~=primary]{--tcds-icon: var(--tcds-icon-primary-blood-pressure)}.tcds-icon--blood-test,.tcds-icon--blood-test--primary,.bg-icon--blood-test,.bg-icon--blood-test--primary,tcds-icon[icon~=blood-test],tcds-icon[icon~=blood-test][category~=primary]{--tcds-icon: var(--tcds-icon-primary-blood-test)}.tcds-icon--bone-density-scan,.tcds-icon--bone-density-scan--primary,.bg-icon--bone-density-scan,.bg-icon--bone-density-scan--primary,tcds-icon[icon~=bone-density-scan],tcds-icon[icon~=bone-density-scan][category~=primary]{--tcds-icon: var(--tcds-icon-primary-bone-density-scan)}.tcds-icon--caduceus,.tcds-icon--caduceus--primary,.bg-icon--caduceus,.bg-icon--caduceus--primary,tcds-icon[icon~=caduceus],tcds-icon[icon~=caduceus][category~=primary]{--tcds-icon: var(--tcds-icon-primary-caduceus)}.tcds-icon--cardiac-dspect,.tcds-icon--cardiac-dspect--primary,.bg-icon--cardiac-dspect,.bg-icon--cardiac-dspect--primary,tcds-icon[icon~=cardiac-dspect],tcds-icon[icon~=cardiac-dspect][category~=primary]{--tcds-icon: var(--tcds-icon-primary-cardiac-dspect)}.tcds-icon--cardiac-pet-perfusion,.tcds-icon--cardiac-pet-perfusion--primary,.bg-icon--cardiac-pet-perfusion,.bg-icon--cardiac-pet-perfusion--primary,tcds-icon[icon~=cardiac-pet-perfusion],tcds-icon[icon~=cardiac-pet-perfusion][category~=primary]{--tcds-icon: var(--tcds-icon-primary-cardiac-pet-perfusion)}.tcds-icon--crutches,.tcds-icon--crutches--primary,.bg-icon--crutches,.bg-icon--crutches--primary,tcds-icon[icon~=crutches],tcds-icon[icon~=crutches][category~=primary]{--tcds-icon: var(--tcds-icon-primary-crutches)}.tcds-icon--diagnosis,.tcds-icon--diagnosis--primary,.bg-icon--diagnosis,.bg-icon--diagnosis--primary,tcds-icon[icon~=diagnosis],tcds-icon[icon~=diagnosis][category~=primary]{--tcds-icon: var(--tcds-icon-primary-diagnosis)}.tcds-icon--doctor-man,.tcds-icon--doctor-man--primary,.bg-icon--doctor-man,.bg-icon--doctor-man--primary,tcds-icon[icon~=doctor-man],tcds-icon[icon~=doctor-man][category~=primary]{--tcds-icon: var(--tcds-icon-primary-doctor-man)}.tcds-icon--electrocardiogram,.tcds-icon--electrocardiogram--primary,.bg-icon--electrocardiogram,.bg-icon--electrocardiogram--primary,tcds-icon[icon~=electrocardiogram],tcds-icon[icon~=electrocardiogram][category~=primary]{--tcds-icon: var(--tcds-icon-primary-electrocardiogram)}.tcds-icon--endoscope,.tcds-icon--endoscope--primary,.bg-icon--endoscope,.bg-icon--endoscope--primary,tcds-icon[icon~=endoscope],tcds-icon[icon~=endoscope][category~=primary]{--tcds-icon: var(--tcds-icon-primary-endoscope)}.tcds-icon--eye-test,.tcds-icon--eye-test--primary,.bg-icon--eye-test,.bg-icon--eye-test--primary,tcds-icon[icon~=eye-test],tcds-icon[icon~=eye-test][category~=primary]{--tcds-icon: var(--tcds-icon-primary-eye-test)}.tcds-icon--first-aid,.tcds-icon--first-aid--primary,.bg-icon--first-aid,.bg-icon--first-aid--primary,tcds-icon[icon~=first-aid],tcds-icon[icon~=first-aid][category~=primary]{--tcds-icon: var(--tcds-icon-primary-first-aid)}.tcds-icon--fluoroscopy,.tcds-icon--fluoroscopy--primary,.bg-icon--fluoroscopy,.bg-icon--fluoroscopy--primary,tcds-icon[icon~=fluoroscopy],tcds-icon[icon~=fluoroscopy][category~=primary]{--tcds-icon: var(--tcds-icon-primary-fluoroscopy)}.tcds-icon--heartbeat,.tcds-icon--heartbeat--primary,.bg-icon--heartbeat,.bg-icon--heartbeat--primary,tcds-icon[icon~=heartbeat],tcds-icon[icon~=heartbeat][category~=primary]{--tcds-icon: var(--tcds-icon-primary-heartbeat)}.tcds-icon--helicopter,.tcds-icon--helicopter--primary,.bg-icon--helicopter,.bg-icon--helicopter--primary,tcds-icon[icon~=helicopter],tcds-icon[icon~=helicopter][category~=primary]{--tcds-icon: var(--tcds-icon-primary-helicopter)}.tcds-icon--hospital,.tcds-icon--hospital--primary,.bg-icon--hospital,.bg-icon--hospital--primary,tcds-icon[icon~=hospital],tcds-icon[icon~=hospital][category~=primary]{--tcds-icon: var(--tcds-icon-primary-hospital)}.tcds-icon--infections,.tcds-icon--infections--primary,.bg-icon--infections,.bg-icon--infections--primary,tcds-icon[icon~=infections],tcds-icon[icon~=infections][category~=primary]{--tcds-icon: var(--tcds-icon-primary-infections)}.tcds-icon--infusion,.tcds-icon--infusion--primary,.bg-icon--infusion,.bg-icon--infusion--primary,tcds-icon[icon~=infusion],tcds-icon[icon~=infusion][category~=primary]{--tcds-icon: var(--tcds-icon-primary-infusion)}.tcds-icon--injection,.tcds-icon--injection--primary,.bg-icon--injection,.bg-icon--injection--primary,tcds-icon[icon~=injection],tcds-icon[icon~=injection][category~=primary]{--tcds-icon: var(--tcds-icon-primary-injection)}.tcds-icon--lab-analysis,.tcds-icon--lab-analysis--primary,.bg-icon--lab-analysis,.bg-icon--lab-analysis--primary,tcds-icon[icon~=lab-analysis],tcds-icon[icon~=lab-analysis][category~=primary]{--tcds-icon: var(--tcds-icon-primary-lab-analysis)}.tcds-icon--location-pin-1,.tcds-icon--location-pin-1--primary,.bg-icon--location-pin-1,.bg-icon--location-pin-1--primary,tcds-icon[icon~=location-pin-1],tcds-icon[icon~=location-pin-1][category~=primary]{--tcds-icon: var(--tcds-icon-primary-location-pin-1)}.tcds-icon--location-pin-2,.tcds-icon--location-pin-2--primary,.bg-icon--location-pin-2,.bg-icon--location-pin-2--primary,tcds-icon[icon~=location-pin-2],tcds-icon[icon~=location-pin-2][category~=primary]{--tcds-icon: var(--tcds-icon-primary-location-pin-2)}.tcds-icon--loved-one,.tcds-icon--loved-one--primary,.bg-icon--loved-one,.bg-icon--loved-one--primary,tcds-icon[icon~=loved-one],tcds-icon[icon~=loved-one][category~=primary]{--tcds-icon: var(--tcds-icon-primary-loved-one)}.tcds-icon--mammogram,.tcds-icon--mammogram--primary,.bg-icon--mammogram,.bg-icon--mammogram--primary,tcds-icon[icon~=mammogram],tcds-icon[icon~=mammogram][category~=primary]{--tcds-icon: var(--tcds-icon-primary-mammogram)}.tcds-icon--medical-records,.tcds-icon--medical-records--primary,.bg-icon--medical-records,.bg-icon--medical-records--primary,tcds-icon[icon~=medical-records],tcds-icon[icon~=medical-records][category~=primary]{--tcds-icon: var(--tcds-icon-primary-medical-records)}.tcds-icon--medical-support,.tcds-icon--medical-support--primary,.bg-icon--medical-support,.bg-icon--medical-support--primary,tcds-icon[icon~=medical-support],tcds-icon[icon~=medical-support][category~=primary]{--tcds-icon: var(--tcds-icon-primary-medical-support)}.tcds-icon--medical-treatment,.tcds-icon--medical-treatment--primary,.bg-icon--medical-treatment,.bg-icon--medical-treatment--primary,tcds-icon[icon~=medical-treatment],tcds-icon[icon~=medical-treatment][category~=primary]{--tcds-icon: var(--tcds-icon-primary-medical-treatment)}.tcds-icon--medicine-pills,.tcds-icon--medicine-pills--primary,.bg-icon--medicine-pills,.bg-icon--medicine-pills--primary,tcds-icon[icon~=medicine-pills],tcds-icon[icon~=medicine-pills][category~=primary]{--tcds-icon: var(--tcds-icon-primary-medicine-pills)}.tcds-icon--mental-health,.tcds-icon--mental-health--primary,.bg-icon--mental-health,.bg-icon--mental-health--primary,tcds-icon[icon~=mental-health],tcds-icon[icon~=mental-health][category~=primary]{--tcds-icon: var(--tcds-icon-primary-mental-health)}.tcds-icon--mobile-app-healthcare,.tcds-icon--mobile-app-healthcare--primary,.bg-icon--mobile-app-healthcare,.bg-icon--mobile-app-healthcare--primary,tcds-icon[icon~=mobile-app-healthcare],tcds-icon[icon~=mobile-app-healthcare][category~=primary]{--tcds-icon: var(--tcds-icon-primary-mobile-app-healthcare)}.tcds-icon--mobile-healthcare,.tcds-icon--mobile-healthcare--primary,.bg-icon--mobile-healthcare,.bg-icon--mobile-healthcare--primary,tcds-icon[icon~=mobile-healthcare],tcds-icon[icon~=mobile-healthcare][category~=primary]{--tcds-icon: var(--tcds-icon-primary-mobile-healthcare)}.tcds-icon--mobile-phone,.tcds-icon--mobile-phone--primary,.bg-icon--mobile-phone,.bg-icon--mobile-phone--primary,tcds-icon[icon~=mobile-phone],tcds-icon[icon~=mobile-phone][category~=primary]{--tcds-icon: var(--tcds-icon-primary-mobile-phone)}.tcds-icon--mri-1,.tcds-icon--mri-1--primary,.bg-icon--mri-1,.bg-icon--mri-1--primary,tcds-icon[icon~=mri-1],tcds-icon[icon~=mri-1][category~=primary]{--tcds-icon: var(--tcds-icon-primary-mri-1)}.tcds-icon--mri-2,.tcds-icon--mri-2--primary,.bg-icon--mri-2,.bg-icon--mri-2--primary,tcds-icon[icon~=mri-2],tcds-icon[icon~=mri-2][category~=primary]{--tcds-icon: var(--tcds-icon-primary-mri-2)}.tcds-icon--mri-3,.tcds-icon--mri-3--primary,.bg-icon--mri-3,.bg-icon--mri-3--primary,tcds-icon[icon~=mri-3],tcds-icon[icon~=mri-3][category~=primary]{--tcds-icon: var(--tcds-icon-primary-mri-3)}.tcds-icon--mri-4-contrast,.tcds-icon--mri-4-contrast--primary,.bg-icon--mri-4-contrast,.bg-icon--mri-4-contrast--primary,tcds-icon[icon~=mri-4-contrast],tcds-icon[icon~=mri-4-contrast][category~=primary]{--tcds-icon: var(--tcds-icon-primary-mri-4-contrast)}.tcds-icon--mri-4,.tcds-icon--mri-4--primary,.bg-icon--mri-4,.bg-icon--mri-4--primary,tcds-icon[icon~=mri-4],tcds-icon[icon~=mri-4][category~=primary]{--tcds-icon: var(--tcds-icon-primary-mri-4)}.tcds-icon--neurology,.tcds-icon--neurology--primary,.bg-icon--neurology,.bg-icon--neurology--primary,tcds-icon[icon~=neurology],tcds-icon[icon~=neurology][category~=primary]{--tcds-icon: var(--tcds-icon-primary-neurology)}.tcds-icon--nurse,.tcds-icon--nurse--primary,.bg-icon--nurse,.bg-icon--nurse--primary,tcds-icon[icon~=nurse],tcds-icon[icon~=nurse][category~=primary]{--tcds-icon: var(--tcds-icon-primary-nurse)}.tcds-icon--online-diagnosis,.tcds-icon--online-diagnosis--primary,.bg-icon--online-diagnosis,.bg-icon--online-diagnosis--primary,tcds-icon[icon~=online-diagnosis],tcds-icon[icon~=online-diagnosis][category~=primary]{--tcds-icon: var(--tcds-icon-primary-online-diagnosis)}.tcds-icon--organ-donation,.tcds-icon--organ-donation--primary,.bg-icon--organ-donation,.bg-icon--organ-donation--primary,tcds-icon[icon~=organ-donation],tcds-icon[icon~=organ-donation][category~=primary]{--tcds-icon: var(--tcds-icon-primary-organ-donation)}.tcds-icon--ovaries,.tcds-icon--ovaries--primary,.bg-icon--ovaries,.bg-icon--ovaries--primary,tcds-icon[icon~=ovaries],tcds-icon[icon~=ovaries][category~=primary]{--tcds-icon: var(--tcds-icon-primary-ovaries)}.tcds-icon--patient-care,.tcds-icon--patient-care--primary,.bg-icon--patient-care,.bg-icon--patient-care--primary,tcds-icon[icon~=patient-care],tcds-icon[icon~=patient-care][category~=primary]{--tcds-icon: var(--tcds-icon-primary-patient-care)}.tcds-icon--physical-exam,.tcds-icon--physical-exam--primary,.bg-icon--physical-exam,.bg-icon--physical-exam--primary,tcds-icon[icon~=physical-exam],tcds-icon[icon~=physical-exam][category~=primary]{--tcds-icon: var(--tcds-icon-primary-physical-exam)}.tcds-icon--provider,.tcds-icon--provider--primary,.bg-icon--provider,.bg-icon--provider--primary,tcds-icon[icon~=provider],tcds-icon[icon~=provider][category~=primary]{--tcds-icon: var(--tcds-icon-primary-provider)}.tcds-icon--radiation,.tcds-icon--radiation--primary,.bg-icon--radiation,.bg-icon--radiation--primary,tcds-icon[icon~=radiation],tcds-icon[icon~=radiation][category~=primary]{--tcds-icon: var(--tcds-icon-primary-radiation)}.tcds-icon--radiology,.tcds-icon--radiology--primary,.bg-icon--radiology,.bg-icon--radiology--primary,tcds-icon[icon~=radiology],tcds-icon[icon~=radiology][category~=primary]{--tcds-icon: var(--tcds-icon-primary-radiology)}.tcds-icon--schedule,.tcds-icon--schedule--primary,.bg-icon--schedule,.bg-icon--schedule--primary,tcds-icon[icon~=schedule],tcds-icon[icon~=schedule][category~=primary]{--tcds-icon: var(--tcds-icon-primary-schedule)}.tcds-icon--search-heart,.tcds-icon--search-heart--primary,.bg-icon--search-heart,.bg-icon--search-heart--primary,tcds-icon[icon~=search-heart],tcds-icon[icon~=search-heart][category~=primary]{--tcds-icon: var(--tcds-icon-primary-search-heart)}.tcds-icon--service,.tcds-icon--service--primary,.bg-icon--service,.bg-icon--service--primary,tcds-icon[icon~=service],tcds-icon[icon~=service][category~=primary]{--tcds-icon: var(--tcds-icon-primary-service)}.tcds-icon--sexology,.tcds-icon--sexology--primary,.bg-icon--sexology,.bg-icon--sexology--primary,tcds-icon[icon~=sexology],tcds-icon[icon~=sexology][category~=primary]{--tcds-icon: var(--tcds-icon-primary-sexology)}.tcds-icon--stethoscope,.tcds-icon--stethoscope--primary,.bg-icon--stethoscope,.bg-icon--stethoscope--primary,tcds-icon[icon~=stethoscope],tcds-icon[icon~=stethoscope][category~=primary]{--tcds-icon: var(--tcds-icon-primary-stethoscope)}.tcds-icon--stretcher,.tcds-icon--stretcher--primary,.bg-icon--stretcher,.bg-icon--stretcher--primary,tcds-icon[icon~=stretcher],tcds-icon[icon~=stretcher][category~=primary]{--tcds-icon: var(--tcds-icon-primary-stretcher)}.tcds-icon--surgery,.tcds-icon--surgery--primary,.bg-icon--surgery,.bg-icon--surgery--primary,tcds-icon[icon~=surgery],tcds-icon[icon~=surgery][category~=primary]{--tcds-icon: var(--tcds-icon-primary-surgery)}.tcds-icon--ultrasound-1,.tcds-icon--ultrasound-1--primary,.bg-icon--ultrasound-1,.bg-icon--ultrasound-1--primary,tcds-icon[icon~=ultrasound-1],tcds-icon[icon~=ultrasound-1][category~=primary]{--tcds-icon: var(--tcds-icon-primary-ultrasound-1)}.tcds-icon--ultrasound-2,.tcds-icon--ultrasound-2--primary,.bg-icon--ultrasound-2,.bg-icon--ultrasound-2--primary,tcds-icon[icon~=ultrasound-2],tcds-icon[icon~=ultrasound-2][category~=primary]{--tcds-icon: var(--tcds-icon-primary-ultrasound-2)}.tcds-icon--virtual-care,.tcds-icon--virtual-care--primary,.bg-icon--virtual-care,.bg-icon--virtual-care--primary,tcds-icon[icon~=virtual-care],tcds-icon[icon~=virtual-care][category~=primary]{--tcds-icon: var(--tcds-icon-primary-virtual-care)}.tcds-icon--wheelchair,.tcds-icon--wheelchair--primary,.bg-icon--wheelchair,.bg-icon--wheelchair--primary,tcds-icon[icon~=wheelchair],tcds-icon[icon~=wheelchair][category~=primary]{--tcds-icon: var(--tcds-icon-primary-wheelchair)}.tcds-icon--x-ray-bone,.tcds-icon--x-ray-bone--primary,.bg-icon--x-ray-bone,.bg-icon--x-ray-bone--primary,tcds-icon[icon~=x-ray-bone],tcds-icon[icon~=x-ray-bone][category~=primary]{--tcds-icon: var(--tcds-icon-primary-x-ray-bone)}.tcds-icon--x-ray-examination,.tcds-icon--x-ray-examination--primary,.bg-icon--x-ray-examination,.bg-icon--x-ray-examination--primary,tcds-icon[icon~=x-ray-examination],tcds-icon[icon~=x-ray-examination][category~=primary]{--tcds-icon: var(--tcds-icon-primary-x-ray-examination)}.tcds-icon--x-ray-machine,.tcds-icon--x-ray-machine--primary,.bg-icon--x-ray-machine,.bg-icon--x-ray-machine--primary,tcds-icon[icon~=x-ray-machine],tcds-icon[icon~=x-ray-machine][category~=primary]{--tcds-icon: var(--tcds-icon-primary-x-ray-machine)}.tcds-icon--x-ray-skull,.tcds-icon--x-ray-skull--primary,.bg-icon--x-ray-skull,.bg-icon--x-ray-skull--primary,tcds-icon[icon~=x-ray-skull],tcds-icon[icon~=x-ray-skull][category~=primary]{--tcds-icon: var(--tcds-icon-primary-x-ray-skull)}.tcds-icon--x-ray-tooth,.tcds-icon--x-ray-tooth--primary,.bg-icon--x-ray-tooth,.bg-icon--x-ray-tooth--primary,tcds-icon[icon~=x-ray-tooth],tcds-icon[icon~=x-ray-tooth][category~=primary]{--tcds-icon: var(--tcds-icon-primary-x-ray-tooth)}.tcds-icon--arrow-down,.tcds-icon--arrow-down--utility,.bg-icon--arrow-down,.bg-icon--arrow-down--utility,tcds-icon[icon~=arrow-down],tcds-icon[icon~=arrow-down][category~=utility]{--tcds-icon: var(--tcds-icon-utility-arrow-down)}.tcds-icon--arrow-left,.tcds-icon--arrow-left--utility,.bg-icon--arrow-left,.bg-icon--arrow-left--utility,tcds-icon[icon~=arrow-left],tcds-icon[icon~=arrow-left][category~=utility]{--tcds-icon: var(--tcds-icon-utility-arrow-left)}.tcds-icon--arrow-right,.tcds-icon--arrow-right--utility,.bg-icon--arrow-right,.bg-icon--arrow-right--utility,tcds-icon[icon~=arrow-right],tcds-icon[icon~=arrow-right][category~=utility]{--tcds-icon: var(--tcds-icon-utility-arrow-right)}.tcds-icon--arrow-up,.tcds-icon--arrow-up--utility,.bg-icon--arrow-up,.bg-icon--arrow-up--utility,tcds-icon[icon~=arrow-up],tcds-icon[icon~=arrow-up][category~=utility]{--tcds-icon: var(--tcds-icon-utility-arrow-up)}.tcds-icon--caret-down-small,.tcds-icon--caret-down-small--utility,.bg-icon--caret-down-small,.bg-icon--caret-down-small--utility,tcds-icon[icon~=caret-down-small],tcds-icon[icon~=caret-down-small][category~=utility]{--tcds-icon: var(--tcds-icon-utility-caret-down-small)}.tcds-icon--caret-down,.tcds-icon--caret-down--utility,.bg-icon--caret-down,.bg-icon--caret-down--utility,tcds-icon[icon~=caret-down],tcds-icon[icon~=caret-down][category~=utility]{--tcds-icon: var(--tcds-icon-utility-caret-down)}.tcds-icon--caret-left-small,.tcds-icon--caret-left-small--utility,.bg-icon--caret-left-small,.bg-icon--caret-left-small--utility,tcds-icon[icon~=caret-left-small],tcds-icon[icon~=caret-left-small][category~=utility]{--tcds-icon: var(--tcds-icon-utility-caret-left-small)}.tcds-icon--caret-left,.tcds-icon--caret-left--utility,.bg-icon--caret-left,.bg-icon--caret-left--utility,tcds-icon[icon~=caret-left],tcds-icon[icon~=caret-left][category~=utility]{--tcds-icon: var(--tcds-icon-utility-caret-left)}.tcds-icon--caret-right-small,.tcds-icon--caret-right-small--utility,.bg-icon--caret-right-small,.bg-icon--caret-right-small--utility,tcds-icon[icon~=caret-right-small],tcds-icon[icon~=caret-right-small][category~=utility]{--tcds-icon: var(--tcds-icon-utility-caret-right-small)}.tcds-icon--caret-right,.tcds-icon--caret-right--utility,.bg-icon--caret-right,.bg-icon--caret-right--utility,tcds-icon[icon~=caret-right],tcds-icon[icon~=caret-right][category~=utility]{--tcds-icon: var(--tcds-icon-utility-caret-right)}.tcds-icon--caret-up-small,.tcds-icon--caret-up-small--utility,.bg-icon--caret-up-small,.bg-icon--caret-up-small--utility,tcds-icon[icon~=caret-up-small],tcds-icon[icon~=caret-up-small][category~=utility]{--tcds-icon: var(--tcds-icon-utility-caret-up-small)}.tcds-icon--caret-up,.tcds-icon--caret-up--utility,.bg-icon--caret-up,.bg-icon--caret-up--utility,tcds-icon[icon~=caret-up],tcds-icon[icon~=caret-up][category~=utility]{--tcds-icon: var(--tcds-icon-utility-caret-up)}.tcds-icon--check,.tcds-icon--check--utility,.bg-icon--check,.bg-icon--check--utility,tcds-icon[icon~=check],tcds-icon[icon~=check][category~=utility]{--tcds-icon: var(--tcds-icon-utility-check)}.tcds-icon--close,.tcds-icon--close--utility,.bg-icon--close,.bg-icon--close--utility,tcds-icon[icon~=close],tcds-icon[icon~=close][category~=utility]{--tcds-icon: var(--tcds-icon-utility-close)}.tcds-icon--desktop,.tcds-icon--desktop--utility,.bg-icon--desktop,.bg-icon--desktop--utility,tcds-icon[icon~=desktop],tcds-icon[icon~=desktop][category~=utility]{--tcds-icon: var(--tcds-icon-utility-desktop)}.tcds-icon--download,.tcds-icon--download--utility,.bg-icon--download,.bg-icon--download--utility,tcds-icon[icon~=download],tcds-icon[icon~=download][category~=utility]{--tcds-icon: var(--tcds-icon-utility-download)}.tcds-icon--error,.tcds-icon--error--utility,.bg-icon--error,.bg-icon--error--utility,tcds-icon[icon~=error],tcds-icon[icon~=error][category~=utility]{--tcds-icon: var(--tcds-icon-utility-error)}.tcds-icon--external,.tcds-icon--external--utility,.bg-icon--external,.bg-icon--external--utility,tcds-icon[icon~=external],tcds-icon[icon~=external][category~=utility]{--tcds-icon: var(--tcds-icon-utility-external)}.tcds-icon--filter,.tcds-icon--filter--utility,.bg-icon--filter,.bg-icon--filter--utility,tcds-icon[icon~=filter],tcds-icon[icon~=filter][category~=utility]{--tcds-icon: var(--tcds-icon-utility-filter)}.tcds-icon--geolocate,.tcds-icon--geolocate--utility,.bg-icon--geolocate,.bg-icon--geolocate--utility,tcds-icon[icon~=geolocate],tcds-icon[icon~=geolocate][category~=utility]{--tcds-icon: var(--tcds-icon-utility-geolocate)}.tcds-icon--grabber,.tcds-icon--grabber--utility,.bg-icon--grabber,.bg-icon--grabber--utility,tcds-icon[icon~=grabber],tcds-icon[icon~=grabber][category~=utility]{--tcds-icon: var(--tcds-icon-utility-grabber)}.tcds-icon--info,.tcds-icon--info--utility,.bg-icon--info,.bg-icon--info--utility,tcds-icon[icon~=info],tcds-icon[icon~=info][category~=utility]{--tcds-icon: var(--tcds-icon-utility-info)}.tcds-icon--laptop,.tcds-icon--laptop--utility,.bg-icon--laptop,.bg-icon--laptop--utility,tcds-icon[icon~=laptop],tcds-icon[icon~=laptop][category~=utility]{--tcds-icon: var(--tcds-icon-utility-laptop)}.tcds-icon--list,.tcds-icon--list--utility,.bg-icon--list,.bg-icon--list--utility,tcds-icon[icon~=list],tcds-icon[icon~=list][category~=utility]{--tcds-icon: var(--tcds-icon-utility-list)}.tcds-icon--menu,.tcds-icon--menu--utility,.bg-icon--menu,.bg-icon--menu--utility,tcds-icon[icon~=menu],tcds-icon[icon~=menu][category~=utility]{--tcds-icon: var(--tcds-icon-utility-menu)}.tcds-icon--minus,.tcds-icon--minus--utility,.bg-icon--minus,.bg-icon--minus--utility,tcds-icon[icon~=minus],tcds-icon[icon~=minus][category~=utility]{--tcds-icon: var(--tcds-icon-utility-minus)}.tcds-icon--mobile,.tcds-icon--mobile--utility,.bg-icon--mobile,.bg-icon--mobile--utility,tcds-icon[icon~=mobile],tcds-icon[icon~=mobile][category~=utility]{--tcds-icon: var(--tcds-icon-utility-mobile)}.tcds-icon--pause,.tcds-icon--pause--utility,.bg-icon--pause,.bg-icon--pause--utility,tcds-icon[icon~=pause],tcds-icon[icon~=pause][category~=utility]{--tcds-icon: var(--tcds-icon-utility-pause)}.tcds-icon--pin-filled,.tcds-icon--pin-filled--utility,.bg-icon--pin-filled,.bg-icon--pin-filled--utility,tcds-icon[icon~=pin-filled],tcds-icon[icon~=pin-filled][category~=utility]{--tcds-icon: var(--tcds-icon-utility-pin-filled)}.tcds-icon--pin,.tcds-icon--pin--utility,.bg-icon--pin,.bg-icon--pin--utility,tcds-icon[icon~=pin],tcds-icon[icon~=pin][category~=utility]{--tcds-icon: var(--tcds-icon-utility-pin)}.tcds-icon--play,.tcds-icon--play--utility,.bg-icon--play,.bg-icon--play--utility,tcds-icon[icon~=play],tcds-icon[icon~=play][category~=utility]{--tcds-icon: var(--tcds-icon-utility-play)}.tcds-icon--plus,.tcds-icon--plus--utility,.bg-icon--plus,.bg-icon--plus--utility,tcds-icon[icon~=plus],tcds-icon[icon~=plus][category~=utility]{--tcds-icon: var(--tcds-icon-utility-plus)}.tcds-icon--quotation,.tcds-icon--quotation--utility,.bg-icon--quotation,.bg-icon--quotation--utility,tcds-icon[icon~=quotation],tcds-icon[icon~=quotation][category~=utility]{--tcds-icon: var(--tcds-icon-utility-quotation)}.tcds-icon--search,.tcds-icon--search--utility,.bg-icon--search,.bg-icon--search--utility,tcds-icon[icon~=search],tcds-icon[icon~=search][category~=utility]{--tcds-icon: var(--tcds-icon-utility-search)}.tcds-icon--star,.tcds-icon--star--utility,.bg-icon--star,.bg-icon--star--utility,tcds-icon[icon~=star],tcds-icon[icon~=star][category~=utility]{--tcds-icon: var(--tcds-icon-utility-star)}.tcds-icon--stop,.tcds-icon--stop--utility,.bg-icon--stop,.bg-icon--stop--utility,tcds-icon[icon~=stop],tcds-icon[icon~=stop][category~=utility]{--tcds-icon: var(--tcds-icon-utility-stop)}.tcds-icon--tablet,.tcds-icon--tablet--utility,.bg-icon--tablet,.bg-icon--tablet--utility,tcds-icon[icon~=tablet],tcds-icon[icon~=tablet][category~=utility]{--tcds-icon: var(--tcds-icon-utility-tablet)}.justify-content-start{justify-content:start !important}.justify-self-start{justify-self:start !important}.justify-content-end{justify-content:end !important}.justify-self-end{justify-self:end !important}.justify-content-center{justify-content:center !important}.justify-self-center{justify-self:center !important}.justify-content-space-between{justify-content:space-between !important}.justify-self-space-between{justify-self:space-between !important}.align-items-start{align-items:start !important}.align-self-start{align-self:start !important}.align-items-end{align-items:end !important}.align-self-end{align-self:end !important}.align-items-center{align-items:center !important}.align-self-center{align-self:center !important}.align-items-stretch{align-items:stretch !important}.align-self-stretch{align-self:stretch !important}.float-left{float:left !important;margin:0 var(--tcds-space-component-md) var(--tcds-space-component-md) 0}.float-right{float:right !important;margin:0 0 var(--tcds-space-component-md) var(--tcds-space-component-md)}@media(min-width: 320px){.xs\\:justify-content-start{justify-content:start !important}.xs\\:justify-self-start{justify-self:start !important}.xs\\:justify-content-end{justify-content:end !important}.xs\\:justify-self-end{justify-self:end !important}.xs\\:justify-content-center{justify-content:center !important}.xs\\:justify-self-center{justify-self:center !important}.xs\\:justify-content-space-between{justify-content:space-between !important}.xs\\:justify-self-space-between{justify-self:space-between !important}.xs\\:align-items-start{align-items:start !important}.xs\\:align-self-start{align-self:start !important}.xs\\:align-items-end{align-items:end !important}.xs\\:align-self-end{align-self:end !important}.xs\\:align-items-center{align-items:center !important}.xs\\:align-self-center{align-self:center !important}.xs\\:align-items-stretch{align-items:stretch !important}.xs\\:align-self-stretch{align-self:stretch !important}.xs\\:float-left{float:left !important;margin:0 var(--tcds-space-component-md) var(--tcds-space-component-md) 0}.xs\\:float-right{float:right !important;margin:0 0 var(--tcds-space-component-md) var(--tcds-space-component-md)}}@media(min-width: 640px){.sm\\:justify-content-start{justify-content:start !important}.sm\\:justify-self-start{justify-self:start !important}.sm\\:justify-content-end{justify-content:end !important}.sm\\:justify-self-end{justify-self:end !important}.sm\\:justify-content-center{justify-content:center !important}.sm\\:justify-self-center{justify-self:center !important}.sm\\:justify-content-space-between{justify-content:space-between !important}.sm\\:justify-self-space-between{justify-self:space-between !important}.sm\\:align-items-start{align-items:start !important}.sm\\:align-self-start{align-self:start !important}.sm\\:align-items-end{align-items:end !important}.sm\\:align-self-end{align-self:end !important}.sm\\:align-items-center{align-items:center !important}.sm\\:align-self-center{align-self:center !important}.sm\\:align-items-stretch{align-items:stretch !important}.sm\\:align-self-stretch{align-self:stretch !important}.sm\\:float-left{float:left !important;margin:0 var(--tcds-space-component-md) var(--tcds-space-component-md) 0}.sm\\:float-right{float:right !important;margin:0 0 var(--tcds-space-component-md) var(--tcds-space-component-md)}}@media(min-width: 960px){.md\\:justify-content-start{justify-content:start !important}.md\\:justify-self-start{justify-self:start !important}.md\\:justify-content-end{justify-content:end !important}.md\\:justify-self-end{justify-self:end !important}.md\\:justify-content-center{justify-content:center !important}.md\\:justify-self-center{justify-self:center !important}.md\\:justify-content-space-between{justify-content:space-between !important}.md\\:justify-self-space-between{justify-self:space-between !important}.md\\:align-items-start{align-items:start !important}.md\\:align-self-start{align-self:start !important}.md\\:align-items-end{align-items:end !important}.md\\:align-self-end{align-self:end !important}.md\\:align-items-center{align-items:center !important}.md\\:align-self-center{align-self:center !important}.md\\:align-items-stretch{align-items:stretch !important}.md\\:align-self-stretch{align-self:stretch !important}.md\\:float-left{float:left !important;margin:0 var(--tcds-space-component-md) var(--tcds-space-component-md) 0}.md\\:float-right{float:right !important;margin:0 0 var(--tcds-space-component-md) var(--tcds-space-component-md)}}@media(min-width: 1312px){.lg\\:justify-content-start{justify-content:start !important}.lg\\:justify-self-start{justify-self:start !important}.lg\\:justify-content-end{justify-content:end !important}.lg\\:justify-self-end{justify-self:end !important}.lg\\:justify-content-center{justify-content:center !important}.lg\\:justify-self-center{justify-self:center !important}.lg\\:justify-content-space-between{justify-content:space-between !important}.lg\\:justify-self-space-between{justify-self:space-between !important}.lg\\:align-items-start{align-items:start !important}.lg\\:align-self-start{align-self:start !important}.lg\\:align-items-end{align-items:end !important}.lg\\:align-self-end{align-self:end !important}.lg\\:align-items-center{align-items:center !important}.lg\\:align-self-center{align-self:center !important}.lg\\:align-items-stretch{align-items:stretch !important}.lg\\:align-self-stretch{align-self:stretch !important}.lg\\:float-left{float:left !important;margin:0 var(--tcds-space-component-md) var(--tcds-space-component-md) 0}.lg\\:float-right{float:right !important;margin:0 0 var(--tcds-space-component-md) var(--tcds-space-component-md)}}@media(min-width: 1920px){.xl\\:justify-content-start{justify-content:start !important}.xl\\:justify-self-start{justify-self:start !important}.xl\\:justify-content-end{justify-content:end !important}.xl\\:justify-self-end{justify-self:end !important}.xl\\:justify-content-center{justify-content:center !important}.xl\\:justify-self-center{justify-self:center !important}.xl\\:justify-content-space-between{justify-content:space-between !important}.xl\\:justify-self-space-between{justify-self:space-between !important}.xl\\:align-items-start{align-items:start !important}.xl\\:align-self-start{align-self:start !important}.xl\\:align-items-end{align-items:end !important}.xl\\:align-self-end{align-self:end !important}.xl\\:align-items-center{align-items:center !important}.xl\\:align-self-center{align-self:center !important}.xl\\:align-items-stretch{align-items:stretch !important}.xl\\:align-self-stretch{align-self:stretch !important}.xl\\:float-left{float:left !important;margin:0 var(--tcds-space-component-md) var(--tcds-space-component-md) 0}.xl\\:float-right{float:right !important;margin:0 0 var(--tcds-space-component-md) var(--tcds-space-component-md)}}.container-xs{--tcds-size-container: var(--tcds-size-layout-xs)}.container-sm{--tcds-size-container: var(--tcds-size-layout-sm)}.container-md{--tcds-size-container: var(--tcds-size-layout-md)}.container-lg{--tcds-size-container: var(--tcds-size-layout-lg)}.container-xl{--tcds-size-container: var(--tcds-size-layout-xl)}.container-xs,.container-sm,.container-md,.container-lg,.container-xl{--_tcds-container-gutter: var(--tcds-container-gutter, var(--tcds-site-inner-gutter));--_tcds-size-container: var(--tcds-size-container, var(--tcds-size-layout-lg));width:calc(100% - var(--_tcds-container-gutter)*2) !important;max-width:var(--_tcds-size-container) !important;margin-inline:var(--tcds-container-margin-inline, auto) !important;padding:0 !important;position:relative}.flex{display:flex !important}.inline-flex{display:inline-flex !important}.flex:not(.flex--no-wrap){flex-wrap:wrap !important}.flex--column{flex-direction:column !important}.flex-1-0{flex:1 0}.flex--row-reverse{flex-direction:row-reverse !important}@media(min-width: 320px){.xs\\:flex--row{flex-direction:row !important}.xs\\:flex--row-reverse{flex-direction:row-reverse !important}}@media(min-width: 640px){.sm\\:flex--row{flex-direction:row !important}.sm\\:flex--row-reverse{flex-direction:row-reverse !important}}@media(min-width: 960px){.md\\:flex--row{flex-direction:row !important}.md\\:flex--row-reverse{flex-direction:row-reverse !important}}@media(min-width: 1312px){.lg\\:flex--row{flex-direction:row !important}.lg\\:flex--row-reverse{flex-direction:row-reverse !important}}@media(min-width: 1920px){.xl\\:flex--row{flex-direction:row !important}.xl\\:flex--row-reverse{flex-direction:row-reverse !important}}.grid{display:grid !important;grid-template-columns:repeat(12, 1fr)}:where(.grid>*){--grid-item-column-span: 12;grid-column:span var(--grid-item-column-span)}.grid-item--1\\/1{--grid-item-column-span: 12}.grid-item--1\\/2{--grid-item-column-span: 6}.grid-item--1\\/3{--grid-item-column-span: 4}.grid-item--2\\/3{--grid-item-column-span: 8}.grid-item--1\\/4{--grid-item-column-span: 3}.grid-item--3\\/4{--grid-item-column-span: 9}@media(min-width: 320px){.xs\\:grid-item--1\\/1{--grid-item-column-span: 12}.xs\\:grid-item--1\\/2{--grid-item-column-span: 6}.xs\\:grid-item--1\\/3{--grid-item-column-span: 4}.xs\\:grid-item--2\\/3{--grid-item-column-span: 8}.xs\\:grid-item--1\\/4{--grid-item-column-span: 3}.xs\\:grid-item--3\\/4{--grid-item-column-span: 9}}@media(min-width: 640px){.sm\\:grid-item--1\\/1{--grid-item-column-span: 12}.sm\\:grid-item--1\\/2{--grid-item-column-span: 6}.sm\\:grid-item--1\\/3{--grid-item-column-span: 4}.sm\\:grid-item--2\\/3{--grid-item-column-span: 8}.sm\\:grid-item--1\\/4{--grid-item-column-span: 3}.sm\\:grid-item--3\\/4{--grid-item-column-span: 9}}@media(min-width: 960px){.md\\:grid-item--1\\/1{--grid-item-column-span: 12}.md\\:grid-item--1\\/2{--grid-item-column-span: 6}.md\\:grid-item--1\\/3{--grid-item-column-span: 4}.md\\:grid-item--2\\/3{--grid-item-column-span: 8}.md\\:grid-item--1\\/4{--grid-item-column-span: 3}.md\\:grid-item--3\\/4{--grid-item-column-span: 9}}@media(min-width: 1312px){.lg\\:grid-item--1\\/1{--grid-item-column-span: 12}.lg\\:grid-item--1\\/2{--grid-item-column-span: 6}.lg\\:grid-item--1\\/3{--grid-item-column-span: 4}.lg\\:grid-item--2\\/3{--grid-item-column-span: 8}.lg\\:grid-item--1\\/4{--grid-item-column-span: 3}.lg\\:grid-item--3\\/4{--grid-item-column-span: 9}}@media(min-width: 1920px){.xl\\:grid-item--1\\/1{--grid-item-column-span: 12}.xl\\:grid-item--1\\/2{--grid-item-column-span: 6}.xl\\:grid-item--1\\/3{--grid-item-column-span: 4}.xl\\:grid-item--2\\/3{--grid-item-column-span: 8}.xl\\:grid-item--1\\/4{--grid-item-column-span: 3}.xl\\:grid-item--3\\/4{--grid-item-column-span: 9}}[hidden]:where(:not([hidden=until-found])){display:none !important}.hidden{display:none !important}@media(min-width: 320px){.xs\\:hidden{display:none !important}}@media(min-width: 640px){.sm\\:hidden{display:none !important}}@media(min-width: 960px){.md\\:hidden{display:none !important}}@media(min-width: 1312px){.lg\\:hidden{display:none !important}}@media(min-width: 1920px){.xl\\:hidden{display:none !important}}.visually-hidden:not(:focus){clip:rect(0, 0, 0, 0);clip-path:inset(50%);height:1px;width:1px;position:absolute}.visually-hidden:not(:focus){clip:rect(0, 0, 0, 0);clip-path:inset(50%);height:1px;width:1px;position:absolute}@media(min-width: 320px){.xs\\:visually-hidden:not(:focus){clip:rect(0, 0, 0, 0);clip-path:inset(50%);height:1px;width:1px;position:absolute}}@media(min-width: 640px){.sm\\:visually-hidden:not(:focus){clip:rect(0, 0, 0, 0);clip-path:inset(50%);height:1px;width:1px;position:absolute}}@media(min-width: 960px){.md\\:visually-hidden:not(:focus){clip:rect(0, 0, 0, 0);clip-path:inset(50%);height:1px;width:1px;position:absolute}}@media(min-width: 1312px){.lg\\:visually-hidden:not(:focus){clip:rect(0, 0, 0, 0);clip-path:inset(50%);height:1px;width:1px;position:absolute}}@media(min-width: 1920px){.xl\\:visually-hidden:not(:focus){clip:rect(0, 0, 0, 0);clip-path:inset(50%);height:1px;width:1px;position:absolute}}.component-gap-xs{gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.component-row-gap-xs{row-gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.component-column-gap-xs{column-gap:var(--tcds-space-layout-xs) !important}.component-gap-sm{gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.component-row-gap-sm{row-gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.component-column-gap-sm{column-gap:var(--tcds-space-layout-sm) !important}.component-gap-md{gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.component-row-gap-md{row-gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.component-column-gap-md{column-gap:var(--tcds-space-layout-md) !important}.component-gap-lg{gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.component-row-gap-lg{row-gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.component-column-gap-lg{column-gap:var(--tcds-space-layout-lg) !important}.component-gap-xl{gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.component-row-gap-xl{row-gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.component-column-gap-xl{column-gap:var(--tcds-space-layout-xl) !important}.layout-gap-xs{gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.layout-row-gap-xs{row-gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.layout-column-gap-xs{column-gap:var(--tcds-space-layout-xs) !important}.layout-gap-sm{gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.layout-row-gap-sm{row-gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.layout-column-gap-sm{column-gap:var(--tcds-space-layout-sm) !important}.layout-gap-md{gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.layout-row-gap-md{row-gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.layout-column-gap-md{column-gap:var(--tcds-space-layout-md) !important}.layout-gap-lg{gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.layout-row-gap-lg{row-gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.layout-column-gap-lg{column-gap:var(--tcds-space-layout-lg) !important}.layout-gap-xl{gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.layout-row-gap-xl{row-gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.layout-column-gap-xl{column-gap:var(--tcds-space-layout-xl) !important}@media(min-width: 320px){.xs\\:component-gap-xs{gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.xs\\:component-row-gap-xs{row-gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.xs\\:component-column-gap-xs{column-gap:var(--tcds-space-layout-xs) !important}.xs\\:component-gap-sm{gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.xs\\:component-row-gap-sm{row-gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.xs\\:component-column-gap-sm{column-gap:var(--tcds-space-layout-sm) !important}.xs\\:component-gap-md{gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.xs\\:component-row-gap-md{row-gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.xs\\:component-column-gap-md{column-gap:var(--tcds-space-layout-md) !important}.xs\\:component-gap-lg{gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.xs\\:component-row-gap-lg{row-gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.xs\\:component-column-gap-lg{column-gap:var(--tcds-space-layout-lg) !important}.xs\\:component-gap-xl{gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.xs\\:component-row-gap-xl{row-gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.xs\\:component-column-gap-xl{column-gap:var(--tcds-space-layout-xl) !important}.xs\\:layout-gap-xs{gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.xs\\:layout-row-gap-xs{row-gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.xs\\:layout-column-gap-xs{column-gap:var(--tcds-space-layout-xs) !important}.xs\\:layout-gap-sm{gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.xs\\:layout-row-gap-sm{row-gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.xs\\:layout-column-gap-sm{column-gap:var(--tcds-space-layout-sm) !important}.xs\\:layout-gap-md{gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.xs\\:layout-row-gap-md{row-gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.xs\\:layout-column-gap-md{column-gap:var(--tcds-space-layout-md) !important}.xs\\:layout-gap-lg{gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.xs\\:layout-row-gap-lg{row-gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.xs\\:layout-column-gap-lg{column-gap:var(--tcds-space-layout-lg) !important}.xs\\:layout-gap-xl{gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.xs\\:layout-row-gap-xl{row-gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.xs\\:layout-column-gap-xl{column-gap:var(--tcds-space-layout-xl) !important}}@media(min-width: 640px){.sm\\:component-gap-xs{gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.sm\\:component-row-gap-xs{row-gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.sm\\:component-column-gap-xs{column-gap:var(--tcds-space-layout-xs) !important}.sm\\:component-gap-sm{gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.sm\\:component-row-gap-sm{row-gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.sm\\:component-column-gap-sm{column-gap:var(--tcds-space-layout-sm) !important}.sm\\:component-gap-md{gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.sm\\:component-row-gap-md{row-gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.sm\\:component-column-gap-md{column-gap:var(--tcds-space-layout-md) !important}.sm\\:component-gap-lg{gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.sm\\:component-row-gap-lg{row-gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.sm\\:component-column-gap-lg{column-gap:var(--tcds-space-layout-lg) !important}.sm\\:component-gap-xl{gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.sm\\:component-row-gap-xl{row-gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.sm\\:component-column-gap-xl{column-gap:var(--tcds-space-layout-xl) !important}.sm\\:layout-gap-xs{gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.sm\\:layout-row-gap-xs{row-gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.sm\\:layout-column-gap-xs{column-gap:var(--tcds-space-layout-xs) !important}.sm\\:layout-gap-sm{gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.sm\\:layout-row-gap-sm{row-gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.sm\\:layout-column-gap-sm{column-gap:var(--tcds-space-layout-sm) !important}.sm\\:layout-gap-md{gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.sm\\:layout-row-gap-md{row-gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.sm\\:layout-column-gap-md{column-gap:var(--tcds-space-layout-md) !important}.sm\\:layout-gap-lg{gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.sm\\:layout-row-gap-lg{row-gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.sm\\:layout-column-gap-lg{column-gap:var(--tcds-space-layout-lg) !important}.sm\\:layout-gap-xl{gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.sm\\:layout-row-gap-xl{row-gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.sm\\:layout-column-gap-xl{column-gap:var(--tcds-space-layout-xl) !important}}@media(min-width: 960px){.md\\:component-gap-xs{gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.md\\:component-row-gap-xs{row-gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.md\\:component-column-gap-xs{column-gap:var(--tcds-space-layout-xs) !important}.md\\:component-gap-sm{gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.md\\:component-row-gap-sm{row-gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.md\\:component-column-gap-sm{column-gap:var(--tcds-space-layout-sm) !important}.md\\:component-gap-md{gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.md\\:component-row-gap-md{row-gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.md\\:component-column-gap-md{column-gap:var(--tcds-space-layout-md) !important}.md\\:component-gap-lg{gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.md\\:component-row-gap-lg{row-gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.md\\:component-column-gap-lg{column-gap:var(--tcds-space-layout-lg) !important}.md\\:component-gap-xl{gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.md\\:component-row-gap-xl{row-gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.md\\:component-column-gap-xl{column-gap:var(--tcds-space-layout-xl) !important}.md\\:layout-gap-xs{gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.md\\:layout-row-gap-xs{row-gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.md\\:layout-column-gap-xs{column-gap:var(--tcds-space-layout-xs) !important}.md\\:layout-gap-sm{gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.md\\:layout-row-gap-sm{row-gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.md\\:layout-column-gap-sm{column-gap:var(--tcds-space-layout-sm) !important}.md\\:layout-gap-md{gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.md\\:layout-row-gap-md{row-gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.md\\:layout-column-gap-md{column-gap:var(--tcds-space-layout-md) !important}.md\\:layout-gap-lg{gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.md\\:layout-row-gap-lg{row-gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.md\\:layout-column-gap-lg{column-gap:var(--tcds-space-layout-lg) !important}.md\\:layout-gap-xl{gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.md\\:layout-row-gap-xl{row-gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.md\\:layout-column-gap-xl{column-gap:var(--tcds-space-layout-xl) !important}}@media(min-width: 1312px){.lg\\:component-gap-xs{gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.lg\\:component-row-gap-xs{row-gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.lg\\:component-column-gap-xs{column-gap:var(--tcds-space-layout-xs) !important}.lg\\:component-gap-sm{gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.lg\\:component-row-gap-sm{row-gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.lg\\:component-column-gap-sm{column-gap:var(--tcds-space-layout-sm) !important}.lg\\:component-gap-md{gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.lg\\:component-row-gap-md{row-gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.lg\\:component-column-gap-md{column-gap:var(--tcds-space-layout-md) !important}.lg\\:component-gap-lg{gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.lg\\:component-row-gap-lg{row-gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.lg\\:component-column-gap-lg{column-gap:var(--tcds-space-layout-lg) !important}.lg\\:component-gap-xl{gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.lg\\:component-row-gap-xl{row-gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.lg\\:component-column-gap-xl{column-gap:var(--tcds-space-layout-xl) !important}.lg\\:layout-gap-xs{gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.lg\\:layout-row-gap-xs{row-gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.lg\\:layout-column-gap-xs{column-gap:var(--tcds-space-layout-xs) !important}.lg\\:layout-gap-sm{gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.lg\\:layout-row-gap-sm{row-gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.lg\\:layout-column-gap-sm{column-gap:var(--tcds-space-layout-sm) !important}.lg\\:layout-gap-md{gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.lg\\:layout-row-gap-md{row-gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.lg\\:layout-column-gap-md{column-gap:var(--tcds-space-layout-md) !important}.lg\\:layout-gap-lg{gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.lg\\:layout-row-gap-lg{row-gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.lg\\:layout-column-gap-lg{column-gap:var(--tcds-space-layout-lg) !important}.lg\\:layout-gap-xl{gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.lg\\:layout-row-gap-xl{row-gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.lg\\:layout-column-gap-xl{column-gap:var(--tcds-space-layout-xl) !important}}@media(min-width: 1920px){.xl\\:component-gap-xs{gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.xl\\:component-row-gap-xs{row-gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.xl\\:component-column-gap-xs{column-gap:var(--tcds-space-layout-xs) !important}.xl\\:component-gap-sm{gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.xl\\:component-row-gap-sm{row-gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.xl\\:component-column-gap-sm{column-gap:var(--tcds-space-layout-sm) !important}.xl\\:component-gap-md{gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.xl\\:component-row-gap-md{row-gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.xl\\:component-column-gap-md{column-gap:var(--tcds-space-layout-md) !important}.xl\\:component-gap-lg{gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.xl\\:component-row-gap-lg{row-gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.xl\\:component-column-gap-lg{column-gap:var(--tcds-space-layout-lg) !important}.xl\\:component-gap-xl{gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.xl\\:component-row-gap-xl{row-gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.xl\\:component-column-gap-xl{column-gap:var(--tcds-space-layout-xl) !important}.xl\\:layout-gap-xs{gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.xl\\:layout-row-gap-xs{row-gap:min(var(--tcds-space-layout-xs),1.3888888889%) !important}.xl\\:layout-column-gap-xs{column-gap:var(--tcds-space-layout-xs) !important}.xl\\:layout-gap-sm{gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.xl\\:layout-row-gap-sm{row-gap:min(var(--tcds-space-layout-sm),2.0833333333%) !important}.xl\\:layout-column-gap-sm{column-gap:var(--tcds-space-layout-sm) !important}.xl\\:layout-gap-md{gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.xl\\:layout-row-gap-md{row-gap:min(var(--tcds-space-layout-md),4.1666666667%) !important}.xl\\:layout-column-gap-md{column-gap:var(--tcds-space-layout-md) !important}.xl\\:layout-gap-lg{gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.xl\\:layout-row-gap-lg{row-gap:min(var(--tcds-space-layout-lg),5.5555555556%) !important}.xl\\:layout-column-gap-lg{column-gap:var(--tcds-space-layout-lg) !important}.xl\\:layout-gap-xl{gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.xl\\:layout-row-gap-xl{row-gap:min(var(--tcds-space-layout-xl),8.3333333333%) !important}.xl\\:layout-column-gap-xl{column-gap:var(--tcds-space-layout-xl) !important}}.component-padding-block-xs{--padding-block-start: var(--tcds-space-layout-xs);--padding-block-end: var(--tcds-space-layout-xs);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.component-padding-block-start-xs{--padding-block-start: var(--tcds-space-layout-xs);padding-block-start:var(--padding-block-start)}.component-padding-block-end-xs{--padding-block-end: var(--tcds-space-layout-xs);padding-block-end:var(--padding-block-end)}.component-margin-block-xs{--margin-block-start: var(--tcds-space-layout-xs);--margin-block-end: var(--tcds-space-layout-xs);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.component-margin-block-start-xs{--margin-block-start: var(--tcds-space-layout-xs);margin-block-start:var(--margin-block-start)}.component-margin-block-end-xs{--margin-block-end: var(--tcds-space-layout-xs);margin-block-end:var(--margin-block-end)}.component-padding-block-sm{--padding-block-start: var(--tcds-space-layout-sm);--padding-block-end: var(--tcds-space-layout-sm);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.component-padding-block-start-sm{--padding-block-start: var(--tcds-space-layout-sm);padding-block-start:var(--padding-block-start)}.component-padding-block-end-sm{--padding-block-end: var(--tcds-space-layout-sm);padding-block-end:var(--padding-block-end)}.component-margin-block-sm{--margin-block-start: var(--tcds-space-layout-sm);--margin-block-end: var(--tcds-space-layout-sm);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.component-margin-block-start-sm{--margin-block-start: var(--tcds-space-layout-sm);margin-block-start:var(--margin-block-start)}.component-margin-block-end-sm{--margin-block-end: var(--tcds-space-layout-sm);margin-block-end:var(--margin-block-end)}.component-padding-block-md{--padding-block-start: var(--tcds-space-layout-md);--padding-block-end: var(--tcds-space-layout-md);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.component-padding-block-start-md{--padding-block-start: var(--tcds-space-layout-md);padding-block-start:var(--padding-block-start)}.component-padding-block-end-md{--padding-block-end: var(--tcds-space-layout-md);padding-block-end:var(--padding-block-end)}.component-margin-block-md{--margin-block-start: var(--tcds-space-layout-md);--margin-block-end: var(--tcds-space-layout-md);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.component-margin-block-start-md{--margin-block-start: var(--tcds-space-layout-md);margin-block-start:var(--margin-block-start)}.component-margin-block-end-md{--margin-block-end: var(--tcds-space-layout-md);margin-block-end:var(--margin-block-end)}.component-padding-block-lg{--padding-block-start: var(--tcds-space-layout-lg);--padding-block-end: var(--tcds-space-layout-lg);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.component-padding-block-start-lg{--padding-block-start: var(--tcds-space-layout-lg);padding-block-start:var(--padding-block-start)}.component-padding-block-end-lg{--padding-block-end: var(--tcds-space-layout-lg);padding-block-end:var(--padding-block-end)}.component-margin-block-lg{--margin-block-start: var(--tcds-space-layout-lg);--margin-block-end: var(--tcds-space-layout-lg);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.component-margin-block-start-lg{--margin-block-start: var(--tcds-space-layout-lg);margin-block-start:var(--margin-block-start)}.component-margin-block-end-lg{--margin-block-end: var(--tcds-space-layout-lg);margin-block-end:var(--margin-block-end)}.component-padding-block-xl{--padding-block-start: var(--tcds-space-layout-xl);--padding-block-end: var(--tcds-space-layout-xl);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.component-padding-block-start-xl{--padding-block-start: var(--tcds-space-layout-xl);padding-block-start:var(--padding-block-start)}.component-padding-block-end-xl{--padding-block-end: var(--tcds-space-layout-xl);padding-block-end:var(--padding-block-end)}.component-margin-block-xl{--margin-block-start: var(--tcds-space-layout-xl);--margin-block-end: var(--tcds-space-layout-xl);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.component-margin-block-start-xl{--margin-block-start: var(--tcds-space-layout-xl);margin-block-start:var(--margin-block-start)}.component-margin-block-end-xl{--margin-block-end: var(--tcds-space-layout-xl);margin-block-end:var(--margin-block-end)}.layout-padding-block-xs{--padding-block-start: var(--tcds-space-layout-xs);--padding-block-end: var(--tcds-space-layout-xs);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.layout-padding-block-start-xs{--padding-block-start: var(--tcds-space-layout-xs);padding-block-start:var(--padding-block-start)}.layout-padding-block-end-xs{--padding-block-end: var(--tcds-space-layout-xs);padding-block-end:var(--padding-block-end)}.layout-margin-block-xs{--margin-block-start: var(--tcds-space-layout-xs);--margin-block-end: var(--tcds-space-layout-xs);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.layout-margin-block-start-xs{--margin-block-start: var(--tcds-space-layout-xs);margin-block-start:var(--margin-block-start)}.layout-margin-block-end-xs{--margin-block-end: var(--tcds-space-layout-xs);margin-block-end:var(--margin-block-end)}.layout-padding-block-sm{--padding-block-start: var(--tcds-space-layout-sm);--padding-block-end: var(--tcds-space-layout-sm);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.layout-padding-block-start-sm{--padding-block-start: var(--tcds-space-layout-sm);padding-block-start:var(--padding-block-start)}.layout-padding-block-end-sm{--padding-block-end: var(--tcds-space-layout-sm);padding-block-end:var(--padding-block-end)}.layout-margin-block-sm{--margin-block-start: var(--tcds-space-layout-sm);--margin-block-end: var(--tcds-space-layout-sm);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.layout-margin-block-start-sm{--margin-block-start: var(--tcds-space-layout-sm);margin-block-start:var(--margin-block-start)}.layout-margin-block-end-sm{--margin-block-end: var(--tcds-space-layout-sm);margin-block-end:var(--margin-block-end)}.layout-padding-block-md{--padding-block-start: var(--tcds-space-layout-md);--padding-block-end: var(--tcds-space-layout-md);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.layout-padding-block-start-md{--padding-block-start: var(--tcds-space-layout-md);padding-block-start:var(--padding-block-start)}.layout-padding-block-end-md{--padding-block-end: var(--tcds-space-layout-md);padding-block-end:var(--padding-block-end)}.layout-margin-block-md{--margin-block-start: var(--tcds-space-layout-md);--margin-block-end: var(--tcds-space-layout-md);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.layout-margin-block-start-md{--margin-block-start: var(--tcds-space-layout-md);margin-block-start:var(--margin-block-start)}.layout-margin-block-end-md{--margin-block-end: var(--tcds-space-layout-md);margin-block-end:var(--margin-block-end)}.layout-padding-block-lg{--padding-block-start: var(--tcds-space-layout-lg);--padding-block-end: var(--tcds-space-layout-lg);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.layout-padding-block-start-lg{--padding-block-start: var(--tcds-space-layout-lg);padding-block-start:var(--padding-block-start)}.layout-padding-block-end-lg{--padding-block-end: var(--tcds-space-layout-lg);padding-block-end:var(--padding-block-end)}.layout-margin-block-lg{--margin-block-start: var(--tcds-space-layout-lg);--margin-block-end: var(--tcds-space-layout-lg);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.layout-margin-block-start-lg{--margin-block-start: var(--tcds-space-layout-lg);margin-block-start:var(--margin-block-start)}.layout-margin-block-end-lg{--margin-block-end: var(--tcds-space-layout-lg);margin-block-end:var(--margin-block-end)}.layout-padding-block-xl{--padding-block-start: var(--tcds-space-layout-xl);--padding-block-end: var(--tcds-space-layout-xl);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.layout-padding-block-start-xl{--padding-block-start: var(--tcds-space-layout-xl);padding-block-start:var(--padding-block-start)}.layout-padding-block-end-xl{--padding-block-end: var(--tcds-space-layout-xl);padding-block-end:var(--padding-block-end)}.layout-margin-block-xl{--margin-block-start: var(--tcds-space-layout-xl);--margin-block-end: var(--tcds-space-layout-xl);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.layout-margin-block-start-xl{--margin-block-start: var(--tcds-space-layout-xl);margin-block-start:var(--margin-block-start)}.layout-margin-block-end-xl{--margin-block-end: var(--tcds-space-layout-xl);margin-block-end:var(--margin-block-end)}@media(min-width: 320px){.xs\\:component-padding-block-xs{--padding-block-start: var(--tcds-space-layout-xs);--padding-block-end: var(--tcds-space-layout-xs);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xs\\:component-padding-block-start-xs{--padding-block-start: var(--tcds-space-layout-xs);padding-block-start:var(--padding-block-start)}.xs\\:component-padding-block-end-xs{--padding-block-end: var(--tcds-space-layout-xs);padding-block-end:var(--padding-block-end)}.xs\\:component-margin-block-xs{--margin-block-start: var(--tcds-space-layout-xs);--margin-block-end: var(--tcds-space-layout-xs);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xs\\:component-margin-block-start-xs{--margin-block-start: var(--tcds-space-layout-xs);margin-block-start:var(--margin-block-start)}.xs\\:component-margin-block-end-xs{--margin-block-end: var(--tcds-space-layout-xs);margin-block-end:var(--margin-block-end)}.xs\\:component-padding-block-sm{--padding-block-start: var(--tcds-space-layout-sm);--padding-block-end: var(--tcds-space-layout-sm);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xs\\:component-padding-block-start-sm{--padding-block-start: var(--tcds-space-layout-sm);padding-block-start:var(--padding-block-start)}.xs\\:component-padding-block-end-sm{--padding-block-end: var(--tcds-space-layout-sm);padding-block-end:var(--padding-block-end)}.xs\\:component-margin-block-sm{--margin-block-start: var(--tcds-space-layout-sm);--margin-block-end: var(--tcds-space-layout-sm);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xs\\:component-margin-block-start-sm{--margin-block-start: var(--tcds-space-layout-sm);margin-block-start:var(--margin-block-start)}.xs\\:component-margin-block-end-sm{--margin-block-end: var(--tcds-space-layout-sm);margin-block-end:var(--margin-block-end)}.xs\\:component-padding-block-md{--padding-block-start: var(--tcds-space-layout-md);--padding-block-end: var(--tcds-space-layout-md);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xs\\:component-padding-block-start-md{--padding-block-start: var(--tcds-space-layout-md);padding-block-start:var(--padding-block-start)}.xs\\:component-padding-block-end-md{--padding-block-end: var(--tcds-space-layout-md);padding-block-end:var(--padding-block-end)}.xs\\:component-margin-block-md{--margin-block-start: var(--tcds-space-layout-md);--margin-block-end: var(--tcds-space-layout-md);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xs\\:component-margin-block-start-md{--margin-block-start: var(--tcds-space-layout-md);margin-block-start:var(--margin-block-start)}.xs\\:component-margin-block-end-md{--margin-block-end: var(--tcds-space-layout-md);margin-block-end:var(--margin-block-end)}.xs\\:component-padding-block-lg{--padding-block-start: var(--tcds-space-layout-lg);--padding-block-end: var(--tcds-space-layout-lg);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xs\\:component-padding-block-start-lg{--padding-block-start: var(--tcds-space-layout-lg);padding-block-start:var(--padding-block-start)}.xs\\:component-padding-block-end-lg{--padding-block-end: var(--tcds-space-layout-lg);padding-block-end:var(--padding-block-end)}.xs\\:component-margin-block-lg{--margin-block-start: var(--tcds-space-layout-lg);--margin-block-end: var(--tcds-space-layout-lg);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xs\\:component-margin-block-start-lg{--margin-block-start: var(--tcds-space-layout-lg);margin-block-start:var(--margin-block-start)}.xs\\:component-margin-block-end-lg{--margin-block-end: var(--tcds-space-layout-lg);margin-block-end:var(--margin-block-end)}.xs\\:component-padding-block-xl{--padding-block-start: var(--tcds-space-layout-xl);--padding-block-end: var(--tcds-space-layout-xl);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xs\\:component-padding-block-start-xl{--padding-block-start: var(--tcds-space-layout-xl);padding-block-start:var(--padding-block-start)}.xs\\:component-padding-block-end-xl{--padding-block-end: var(--tcds-space-layout-xl);padding-block-end:var(--padding-block-end)}.xs\\:component-margin-block-xl{--margin-block-start: var(--tcds-space-layout-xl);--margin-block-end: var(--tcds-space-layout-xl);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xs\\:component-margin-block-start-xl{--margin-block-start: var(--tcds-space-layout-xl);margin-block-start:var(--margin-block-start)}.xs\\:component-margin-block-end-xl{--margin-block-end: var(--tcds-space-layout-xl);margin-block-end:var(--margin-block-end)}.xs\\:layout-padding-block-xs{--padding-block-start: var(--tcds-space-layout-xs);--padding-block-end: var(--tcds-space-layout-xs);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xs\\:layout-padding-block-start-xs{--padding-block-start: var(--tcds-space-layout-xs);padding-block-start:var(--padding-block-start)}.xs\\:layout-padding-block-end-xs{--padding-block-end: var(--tcds-space-layout-xs);padding-block-end:var(--padding-block-end)}.xs\\:layout-margin-block-xs{--margin-block-start: var(--tcds-space-layout-xs);--margin-block-end: var(--tcds-space-layout-xs);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xs\\:layout-margin-block-start-xs{--margin-block-start: var(--tcds-space-layout-xs);margin-block-start:var(--margin-block-start)}.xs\\:layout-margin-block-end-xs{--margin-block-end: var(--tcds-space-layout-xs);margin-block-end:var(--margin-block-end)}.xs\\:layout-padding-block-sm{--padding-block-start: var(--tcds-space-layout-sm);--padding-block-end: var(--tcds-space-layout-sm);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xs\\:layout-padding-block-start-sm{--padding-block-start: var(--tcds-space-layout-sm);padding-block-start:var(--padding-block-start)}.xs\\:layout-padding-block-end-sm{--padding-block-end: var(--tcds-space-layout-sm);padding-block-end:var(--padding-block-end)}.xs\\:layout-margin-block-sm{--margin-block-start: var(--tcds-space-layout-sm);--margin-block-end: var(--tcds-space-layout-sm);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xs\\:layout-margin-block-start-sm{--margin-block-start: var(--tcds-space-layout-sm);margin-block-start:var(--margin-block-start)}.xs\\:layout-margin-block-end-sm{--margin-block-end: var(--tcds-space-layout-sm);margin-block-end:var(--margin-block-end)}.xs\\:layout-padding-block-md{--padding-block-start: var(--tcds-space-layout-md);--padding-block-end: var(--tcds-space-layout-md);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xs\\:layout-padding-block-start-md{--padding-block-start: var(--tcds-space-layout-md);padding-block-start:var(--padding-block-start)}.xs\\:layout-padding-block-end-md{--padding-block-end: var(--tcds-space-layout-md);padding-block-end:var(--padding-block-end)}.xs\\:layout-margin-block-md{--margin-block-start: var(--tcds-space-layout-md);--margin-block-end: var(--tcds-space-layout-md);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xs\\:layout-margin-block-start-md{--margin-block-start: var(--tcds-space-layout-md);margin-block-start:var(--margin-block-start)}.xs\\:layout-margin-block-end-md{--margin-block-end: var(--tcds-space-layout-md);margin-block-end:var(--margin-block-end)}.xs\\:layout-padding-block-lg{--padding-block-start: var(--tcds-space-layout-lg);--padding-block-end: var(--tcds-space-layout-lg);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xs\\:layout-padding-block-start-lg{--padding-block-start: var(--tcds-space-layout-lg);padding-block-start:var(--padding-block-start)}.xs\\:layout-padding-block-end-lg{--padding-block-end: var(--tcds-space-layout-lg);padding-block-end:var(--padding-block-end)}.xs\\:layout-margin-block-lg{--margin-block-start: var(--tcds-space-layout-lg);--margin-block-end: var(--tcds-space-layout-lg);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xs\\:layout-margin-block-start-lg{--margin-block-start: var(--tcds-space-layout-lg);margin-block-start:var(--margin-block-start)}.xs\\:layout-margin-block-end-lg{--margin-block-end: var(--tcds-space-layout-lg);margin-block-end:var(--margin-block-end)}.xs\\:layout-padding-block-xl{--padding-block-start: var(--tcds-space-layout-xl);--padding-block-end: var(--tcds-space-layout-xl);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xs\\:layout-padding-block-start-xl{--padding-block-start: var(--tcds-space-layout-xl);padding-block-start:var(--padding-block-start)}.xs\\:layout-padding-block-end-xl{--padding-block-end: var(--tcds-space-layout-xl);padding-block-end:var(--padding-block-end)}.xs\\:layout-margin-block-xl{--margin-block-start: var(--tcds-space-layout-xl);--margin-block-end: var(--tcds-space-layout-xl);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xs\\:layout-margin-block-start-xl{--margin-block-start: var(--tcds-space-layout-xl);margin-block-start:var(--margin-block-start)}.xs\\:layout-margin-block-end-xl{--margin-block-end: var(--tcds-space-layout-xl);margin-block-end:var(--margin-block-end)}}@media(min-width: 640px){.sm\\:component-padding-block-xs{--padding-block-start: var(--tcds-space-layout-xs);--padding-block-end: var(--tcds-space-layout-xs);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.sm\\:component-padding-block-start-xs{--padding-block-start: var(--tcds-space-layout-xs);padding-block-start:var(--padding-block-start)}.sm\\:component-padding-block-end-xs{--padding-block-end: var(--tcds-space-layout-xs);padding-block-end:var(--padding-block-end)}.sm\\:component-margin-block-xs{--margin-block-start: var(--tcds-space-layout-xs);--margin-block-end: var(--tcds-space-layout-xs);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.sm\\:component-margin-block-start-xs{--margin-block-start: var(--tcds-space-layout-xs);margin-block-start:var(--margin-block-start)}.sm\\:component-margin-block-end-xs{--margin-block-end: var(--tcds-space-layout-xs);margin-block-end:var(--margin-block-end)}.sm\\:component-padding-block-sm{--padding-block-start: var(--tcds-space-layout-sm);--padding-block-end: var(--tcds-space-layout-sm);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.sm\\:component-padding-block-start-sm{--padding-block-start: var(--tcds-space-layout-sm);padding-block-start:var(--padding-block-start)}.sm\\:component-padding-block-end-sm{--padding-block-end: var(--tcds-space-layout-sm);padding-block-end:var(--padding-block-end)}.sm\\:component-margin-block-sm{--margin-block-start: var(--tcds-space-layout-sm);--margin-block-end: var(--tcds-space-layout-sm);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.sm\\:component-margin-block-start-sm{--margin-block-start: var(--tcds-space-layout-sm);margin-block-start:var(--margin-block-start)}.sm\\:component-margin-block-end-sm{--margin-block-end: var(--tcds-space-layout-sm);margin-block-end:var(--margin-block-end)}.sm\\:component-padding-block-md{--padding-block-start: var(--tcds-space-layout-md);--padding-block-end: var(--tcds-space-layout-md);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.sm\\:component-padding-block-start-md{--padding-block-start: var(--tcds-space-layout-md);padding-block-start:var(--padding-block-start)}.sm\\:component-padding-block-end-md{--padding-block-end: var(--tcds-space-layout-md);padding-block-end:var(--padding-block-end)}.sm\\:component-margin-block-md{--margin-block-start: var(--tcds-space-layout-md);--margin-block-end: var(--tcds-space-layout-md);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.sm\\:component-margin-block-start-md{--margin-block-start: var(--tcds-space-layout-md);margin-block-start:var(--margin-block-start)}.sm\\:component-margin-block-end-md{--margin-block-end: var(--tcds-space-layout-md);margin-block-end:var(--margin-block-end)}.sm\\:component-padding-block-lg{--padding-block-start: var(--tcds-space-layout-lg);--padding-block-end: var(--tcds-space-layout-lg);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.sm\\:component-padding-block-start-lg{--padding-block-start: var(--tcds-space-layout-lg);padding-block-start:var(--padding-block-start)}.sm\\:component-padding-block-end-lg{--padding-block-end: var(--tcds-space-layout-lg);padding-block-end:var(--padding-block-end)}.sm\\:component-margin-block-lg{--margin-block-start: var(--tcds-space-layout-lg);--margin-block-end: var(--tcds-space-layout-lg);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.sm\\:component-margin-block-start-lg{--margin-block-start: var(--tcds-space-layout-lg);margin-block-start:var(--margin-block-start)}.sm\\:component-margin-block-end-lg{--margin-block-end: var(--tcds-space-layout-lg);margin-block-end:var(--margin-block-end)}.sm\\:component-padding-block-xl{--padding-block-start: var(--tcds-space-layout-xl);--padding-block-end: var(--tcds-space-layout-xl);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.sm\\:component-padding-block-start-xl{--padding-block-start: var(--tcds-space-layout-xl);padding-block-start:var(--padding-block-start)}.sm\\:component-padding-block-end-xl{--padding-block-end: var(--tcds-space-layout-xl);padding-block-end:var(--padding-block-end)}.sm\\:component-margin-block-xl{--margin-block-start: var(--tcds-space-layout-xl);--margin-block-end: var(--tcds-space-layout-xl);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.sm\\:component-margin-block-start-xl{--margin-block-start: var(--tcds-space-layout-xl);margin-block-start:var(--margin-block-start)}.sm\\:component-margin-block-end-xl{--margin-block-end: var(--tcds-space-layout-xl);margin-block-end:var(--margin-block-end)}.sm\\:layout-padding-block-xs{--padding-block-start: var(--tcds-space-layout-xs);--padding-block-end: var(--tcds-space-layout-xs);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.sm\\:layout-padding-block-start-xs{--padding-block-start: var(--tcds-space-layout-xs);padding-block-start:var(--padding-block-start)}.sm\\:layout-padding-block-end-xs{--padding-block-end: var(--tcds-space-layout-xs);padding-block-end:var(--padding-block-end)}.sm\\:layout-margin-block-xs{--margin-block-start: var(--tcds-space-layout-xs);--margin-block-end: var(--tcds-space-layout-xs);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.sm\\:layout-margin-block-start-xs{--margin-block-start: var(--tcds-space-layout-xs);margin-block-start:var(--margin-block-start)}.sm\\:layout-margin-block-end-xs{--margin-block-end: var(--tcds-space-layout-xs);margin-block-end:var(--margin-block-end)}.sm\\:layout-padding-block-sm{--padding-block-start: var(--tcds-space-layout-sm);--padding-block-end: var(--tcds-space-layout-sm);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.sm\\:layout-padding-block-start-sm{--padding-block-start: var(--tcds-space-layout-sm);padding-block-start:var(--padding-block-start)}.sm\\:layout-padding-block-end-sm{--padding-block-end: var(--tcds-space-layout-sm);padding-block-end:var(--padding-block-end)}.sm\\:layout-margin-block-sm{--margin-block-start: var(--tcds-space-layout-sm);--margin-block-end: var(--tcds-space-layout-sm);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.sm\\:layout-margin-block-start-sm{--margin-block-start: var(--tcds-space-layout-sm);margin-block-start:var(--margin-block-start)}.sm\\:layout-margin-block-end-sm{--margin-block-end: var(--tcds-space-layout-sm);margin-block-end:var(--margin-block-end)}.sm\\:layout-padding-block-md{--padding-block-start: var(--tcds-space-layout-md);--padding-block-end: var(--tcds-space-layout-md);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.sm\\:layout-padding-block-start-md{--padding-block-start: var(--tcds-space-layout-md);padding-block-start:var(--padding-block-start)}.sm\\:layout-padding-block-end-md{--padding-block-end: var(--tcds-space-layout-md);padding-block-end:var(--padding-block-end)}.sm\\:layout-margin-block-md{--margin-block-start: var(--tcds-space-layout-md);--margin-block-end: var(--tcds-space-layout-md);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.sm\\:layout-margin-block-start-md{--margin-block-start: var(--tcds-space-layout-md);margin-block-start:var(--margin-block-start)}.sm\\:layout-margin-block-end-md{--margin-block-end: var(--tcds-space-layout-md);margin-block-end:var(--margin-block-end)}.sm\\:layout-padding-block-lg{--padding-block-start: var(--tcds-space-layout-lg);--padding-block-end: var(--tcds-space-layout-lg);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.sm\\:layout-padding-block-start-lg{--padding-block-start: var(--tcds-space-layout-lg);padding-block-start:var(--padding-block-start)}.sm\\:layout-padding-block-end-lg{--padding-block-end: var(--tcds-space-layout-lg);padding-block-end:var(--padding-block-end)}.sm\\:layout-margin-block-lg{--margin-block-start: var(--tcds-space-layout-lg);--margin-block-end: var(--tcds-space-layout-lg);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.sm\\:layout-margin-block-start-lg{--margin-block-start: var(--tcds-space-layout-lg);margin-block-start:var(--margin-block-start)}.sm\\:layout-margin-block-end-lg{--margin-block-end: var(--tcds-space-layout-lg);margin-block-end:var(--margin-block-end)}.sm\\:layout-padding-block-xl{--padding-block-start: var(--tcds-space-layout-xl);--padding-block-end: var(--tcds-space-layout-xl);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.sm\\:layout-padding-block-start-xl{--padding-block-start: var(--tcds-space-layout-xl);padding-block-start:var(--padding-block-start)}.sm\\:layout-padding-block-end-xl{--padding-block-end: var(--tcds-space-layout-xl);padding-block-end:var(--padding-block-end)}.sm\\:layout-margin-block-xl{--margin-block-start: var(--tcds-space-layout-xl);--margin-block-end: var(--tcds-space-layout-xl);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.sm\\:layout-margin-block-start-xl{--margin-block-start: var(--tcds-space-layout-xl);margin-block-start:var(--margin-block-start)}.sm\\:layout-margin-block-end-xl{--margin-block-end: var(--tcds-space-layout-xl);margin-block-end:var(--margin-block-end)}}@media(min-width: 960px){.md\\:component-padding-block-xs{--padding-block-start: var(--tcds-space-layout-xs);--padding-block-end: var(--tcds-space-layout-xs);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.md\\:component-padding-block-start-xs{--padding-block-start: var(--tcds-space-layout-xs);padding-block-start:var(--padding-block-start)}.md\\:component-padding-block-end-xs{--padding-block-end: var(--tcds-space-layout-xs);padding-block-end:var(--padding-block-end)}.md\\:component-margin-block-xs{--margin-block-start: var(--tcds-space-layout-xs);--margin-block-end: var(--tcds-space-layout-xs);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.md\\:component-margin-block-start-xs{--margin-block-start: var(--tcds-space-layout-xs);margin-block-start:var(--margin-block-start)}.md\\:component-margin-block-end-xs{--margin-block-end: var(--tcds-space-layout-xs);margin-block-end:var(--margin-block-end)}.md\\:component-padding-block-sm{--padding-block-start: var(--tcds-space-layout-sm);--padding-block-end: var(--tcds-space-layout-sm);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.md\\:component-padding-block-start-sm{--padding-block-start: var(--tcds-space-layout-sm);padding-block-start:var(--padding-block-start)}.md\\:component-padding-block-end-sm{--padding-block-end: var(--tcds-space-layout-sm);padding-block-end:var(--padding-block-end)}.md\\:component-margin-block-sm{--margin-block-start: var(--tcds-space-layout-sm);--margin-block-end: var(--tcds-space-layout-sm);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.md\\:component-margin-block-start-sm{--margin-block-start: var(--tcds-space-layout-sm);margin-block-start:var(--margin-block-start)}.md\\:component-margin-block-end-sm{--margin-block-end: var(--tcds-space-layout-sm);margin-block-end:var(--margin-block-end)}.md\\:component-padding-block-md{--padding-block-start: var(--tcds-space-layout-md);--padding-block-end: var(--tcds-space-layout-md);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.md\\:component-padding-block-start-md{--padding-block-start: var(--tcds-space-layout-md);padding-block-start:var(--padding-block-start)}.md\\:component-padding-block-end-md{--padding-block-end: var(--tcds-space-layout-md);padding-block-end:var(--padding-block-end)}.md\\:component-margin-block-md{--margin-block-start: var(--tcds-space-layout-md);--margin-block-end: var(--tcds-space-layout-md);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.md\\:component-margin-block-start-md{--margin-block-start: var(--tcds-space-layout-md);margin-block-start:var(--margin-block-start)}.md\\:component-margin-block-end-md{--margin-block-end: var(--tcds-space-layout-md);margin-block-end:var(--margin-block-end)}.md\\:component-padding-block-lg{--padding-block-start: var(--tcds-space-layout-lg);--padding-block-end: var(--tcds-space-layout-lg);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.md\\:component-padding-block-start-lg{--padding-block-start: var(--tcds-space-layout-lg);padding-block-start:var(--padding-block-start)}.md\\:component-padding-block-end-lg{--padding-block-end: var(--tcds-space-layout-lg);padding-block-end:var(--padding-block-end)}.md\\:component-margin-block-lg{--margin-block-start: var(--tcds-space-layout-lg);--margin-block-end: var(--tcds-space-layout-lg);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.md\\:component-margin-block-start-lg{--margin-block-start: var(--tcds-space-layout-lg);margin-block-start:var(--margin-block-start)}.md\\:component-margin-block-end-lg{--margin-block-end: var(--tcds-space-layout-lg);margin-block-end:var(--margin-block-end)}.md\\:component-padding-block-xl{--padding-block-start: var(--tcds-space-layout-xl);--padding-block-end: var(--tcds-space-layout-xl);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.md\\:component-padding-block-start-xl{--padding-block-start: var(--tcds-space-layout-xl);padding-block-start:var(--padding-block-start)}.md\\:component-padding-block-end-xl{--padding-block-end: var(--tcds-space-layout-xl);padding-block-end:var(--padding-block-end)}.md\\:component-margin-block-xl{--margin-block-start: var(--tcds-space-layout-xl);--margin-block-end: var(--tcds-space-layout-xl);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.md\\:component-margin-block-start-xl{--margin-block-start: var(--tcds-space-layout-xl);margin-block-start:var(--margin-block-start)}.md\\:component-margin-block-end-xl{--margin-block-end: var(--tcds-space-layout-xl);margin-block-end:var(--margin-block-end)}.md\\:layout-padding-block-xs{--padding-block-start: var(--tcds-space-layout-xs);--padding-block-end: var(--tcds-space-layout-xs);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.md\\:layout-padding-block-start-xs{--padding-block-start: var(--tcds-space-layout-xs);padding-block-start:var(--padding-block-start)}.md\\:layout-padding-block-end-xs{--padding-block-end: var(--tcds-space-layout-xs);padding-block-end:var(--padding-block-end)}.md\\:layout-margin-block-xs{--margin-block-start: var(--tcds-space-layout-xs);--margin-block-end: var(--tcds-space-layout-xs);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.md\\:layout-margin-block-start-xs{--margin-block-start: var(--tcds-space-layout-xs);margin-block-start:var(--margin-block-start)}.md\\:layout-margin-block-end-xs{--margin-block-end: var(--tcds-space-layout-xs);margin-block-end:var(--margin-block-end)}.md\\:layout-padding-block-sm{--padding-block-start: var(--tcds-space-layout-sm);--padding-block-end: var(--tcds-space-layout-sm);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.md\\:layout-padding-block-start-sm{--padding-block-start: var(--tcds-space-layout-sm);padding-block-start:var(--padding-block-start)}.md\\:layout-padding-block-end-sm{--padding-block-end: var(--tcds-space-layout-sm);padding-block-end:var(--padding-block-end)}.md\\:layout-margin-block-sm{--margin-block-start: var(--tcds-space-layout-sm);--margin-block-end: var(--tcds-space-layout-sm);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.md\\:layout-margin-block-start-sm{--margin-block-start: var(--tcds-space-layout-sm);margin-block-start:var(--margin-block-start)}.md\\:layout-margin-block-end-sm{--margin-block-end: var(--tcds-space-layout-sm);margin-block-end:var(--margin-block-end)}.md\\:layout-padding-block-md{--padding-block-start: var(--tcds-space-layout-md);--padding-block-end: var(--tcds-space-layout-md);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.md\\:layout-padding-block-start-md{--padding-block-start: var(--tcds-space-layout-md);padding-block-start:var(--padding-block-start)}.md\\:layout-padding-block-end-md{--padding-block-end: var(--tcds-space-layout-md);padding-block-end:var(--padding-block-end)}.md\\:layout-margin-block-md{--margin-block-start: var(--tcds-space-layout-md);--margin-block-end: var(--tcds-space-layout-md);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.md\\:layout-margin-block-start-md{--margin-block-start: var(--tcds-space-layout-md);margin-block-start:var(--margin-block-start)}.md\\:layout-margin-block-end-md{--margin-block-end: var(--tcds-space-layout-md);margin-block-end:var(--margin-block-end)}.md\\:layout-padding-block-lg{--padding-block-start: var(--tcds-space-layout-lg);--padding-block-end: var(--tcds-space-layout-lg);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.md\\:layout-padding-block-start-lg{--padding-block-start: var(--tcds-space-layout-lg);padding-block-start:var(--padding-block-start)}.md\\:layout-padding-block-end-lg{--padding-block-end: var(--tcds-space-layout-lg);padding-block-end:var(--padding-block-end)}.md\\:layout-margin-block-lg{--margin-block-start: var(--tcds-space-layout-lg);--margin-block-end: var(--tcds-space-layout-lg);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.md\\:layout-margin-block-start-lg{--margin-block-start: var(--tcds-space-layout-lg);margin-block-start:var(--margin-block-start)}.md\\:layout-margin-block-end-lg{--margin-block-end: var(--tcds-space-layout-lg);margin-block-end:var(--margin-block-end)}.md\\:layout-padding-block-xl{--padding-block-start: var(--tcds-space-layout-xl);--padding-block-end: var(--tcds-space-layout-xl);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.md\\:layout-padding-block-start-xl{--padding-block-start: var(--tcds-space-layout-xl);padding-block-start:var(--padding-block-start)}.md\\:layout-padding-block-end-xl{--padding-block-end: var(--tcds-space-layout-xl);padding-block-end:var(--padding-block-end)}.md\\:layout-margin-block-xl{--margin-block-start: var(--tcds-space-layout-xl);--margin-block-end: var(--tcds-space-layout-xl);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.md\\:layout-margin-block-start-xl{--margin-block-start: var(--tcds-space-layout-xl);margin-block-start:var(--margin-block-start)}.md\\:layout-margin-block-end-xl{--margin-block-end: var(--tcds-space-layout-xl);margin-block-end:var(--margin-block-end)}}@media(min-width: 1312px){.lg\\:component-padding-block-xs{--padding-block-start: var(--tcds-space-layout-xs);--padding-block-end: var(--tcds-space-layout-xs);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.lg\\:component-padding-block-start-xs{--padding-block-start: var(--tcds-space-layout-xs);padding-block-start:var(--padding-block-start)}.lg\\:component-padding-block-end-xs{--padding-block-end: var(--tcds-space-layout-xs);padding-block-end:var(--padding-block-end)}.lg\\:component-margin-block-xs{--margin-block-start: var(--tcds-space-layout-xs);--margin-block-end: var(--tcds-space-layout-xs);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.lg\\:component-margin-block-start-xs{--margin-block-start: var(--tcds-space-layout-xs);margin-block-start:var(--margin-block-start)}.lg\\:component-margin-block-end-xs{--margin-block-end: var(--tcds-space-layout-xs);margin-block-end:var(--margin-block-end)}.lg\\:component-padding-block-sm{--padding-block-start: var(--tcds-space-layout-sm);--padding-block-end: var(--tcds-space-layout-sm);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.lg\\:component-padding-block-start-sm{--padding-block-start: var(--tcds-space-layout-sm);padding-block-start:var(--padding-block-start)}.lg\\:component-padding-block-end-sm{--padding-block-end: var(--tcds-space-layout-sm);padding-block-end:var(--padding-block-end)}.lg\\:component-margin-block-sm{--margin-block-start: var(--tcds-space-layout-sm);--margin-block-end: var(--tcds-space-layout-sm);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.lg\\:component-margin-block-start-sm{--margin-block-start: var(--tcds-space-layout-sm);margin-block-start:var(--margin-block-start)}.lg\\:component-margin-block-end-sm{--margin-block-end: var(--tcds-space-layout-sm);margin-block-end:var(--margin-block-end)}.lg\\:component-padding-block-md{--padding-block-start: var(--tcds-space-layout-md);--padding-block-end: var(--tcds-space-layout-md);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.lg\\:component-padding-block-start-md{--padding-block-start: var(--tcds-space-layout-md);padding-block-start:var(--padding-block-start)}.lg\\:component-padding-block-end-md{--padding-block-end: var(--tcds-space-layout-md);padding-block-end:var(--padding-block-end)}.lg\\:component-margin-block-md{--margin-block-start: var(--tcds-space-layout-md);--margin-block-end: var(--tcds-space-layout-md);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.lg\\:component-margin-block-start-md{--margin-block-start: var(--tcds-space-layout-md);margin-block-start:var(--margin-block-start)}.lg\\:component-margin-block-end-md{--margin-block-end: var(--tcds-space-layout-md);margin-block-end:var(--margin-block-end)}.lg\\:component-padding-block-lg{--padding-block-start: var(--tcds-space-layout-lg);--padding-block-end: var(--tcds-space-layout-lg);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.lg\\:component-padding-block-start-lg{--padding-block-start: var(--tcds-space-layout-lg);padding-block-start:var(--padding-block-start)}.lg\\:component-padding-block-end-lg{--padding-block-end: var(--tcds-space-layout-lg);padding-block-end:var(--padding-block-end)}.lg\\:component-margin-block-lg{--margin-block-start: var(--tcds-space-layout-lg);--margin-block-end: var(--tcds-space-layout-lg);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.lg\\:component-margin-block-start-lg{--margin-block-start: var(--tcds-space-layout-lg);margin-block-start:var(--margin-block-start)}.lg\\:component-margin-block-end-lg{--margin-block-end: var(--tcds-space-layout-lg);margin-block-end:var(--margin-block-end)}.lg\\:component-padding-block-xl{--padding-block-start: var(--tcds-space-layout-xl);--padding-block-end: var(--tcds-space-layout-xl);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.lg\\:component-padding-block-start-xl{--padding-block-start: var(--tcds-space-layout-xl);padding-block-start:var(--padding-block-start)}.lg\\:component-padding-block-end-xl{--padding-block-end: var(--tcds-space-layout-xl);padding-block-end:var(--padding-block-end)}.lg\\:component-margin-block-xl{--margin-block-start: var(--tcds-space-layout-xl);--margin-block-end: var(--tcds-space-layout-xl);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.lg\\:component-margin-block-start-xl{--margin-block-start: var(--tcds-space-layout-xl);margin-block-start:var(--margin-block-start)}.lg\\:component-margin-block-end-xl{--margin-block-end: var(--tcds-space-layout-xl);margin-block-end:var(--margin-block-end)}.lg\\:layout-padding-block-xs{--padding-block-start: var(--tcds-space-layout-xs);--padding-block-end: var(--tcds-space-layout-xs);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.lg\\:layout-padding-block-start-xs{--padding-block-start: var(--tcds-space-layout-xs);padding-block-start:var(--padding-block-start)}.lg\\:layout-padding-block-end-xs{--padding-block-end: var(--tcds-space-layout-xs);padding-block-end:var(--padding-block-end)}.lg\\:layout-margin-block-xs{--margin-block-start: var(--tcds-space-layout-xs);--margin-block-end: var(--tcds-space-layout-xs);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.lg\\:layout-margin-block-start-xs{--margin-block-start: var(--tcds-space-layout-xs);margin-block-start:var(--margin-block-start)}.lg\\:layout-margin-block-end-xs{--margin-block-end: var(--tcds-space-layout-xs);margin-block-end:var(--margin-block-end)}.lg\\:layout-padding-block-sm{--padding-block-start: var(--tcds-space-layout-sm);--padding-block-end: var(--tcds-space-layout-sm);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.lg\\:layout-padding-block-start-sm{--padding-block-start: var(--tcds-space-layout-sm);padding-block-start:var(--padding-block-start)}.lg\\:layout-padding-block-end-sm{--padding-block-end: var(--tcds-space-layout-sm);padding-block-end:var(--padding-block-end)}.lg\\:layout-margin-block-sm{--margin-block-start: var(--tcds-space-layout-sm);--margin-block-end: var(--tcds-space-layout-sm);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.lg\\:layout-margin-block-start-sm{--margin-block-start: var(--tcds-space-layout-sm);margin-block-start:var(--margin-block-start)}.lg\\:layout-margin-block-end-sm{--margin-block-end: var(--tcds-space-layout-sm);margin-block-end:var(--margin-block-end)}.lg\\:layout-padding-block-md{--padding-block-start: var(--tcds-space-layout-md);--padding-block-end: var(--tcds-space-layout-md);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.lg\\:layout-padding-block-start-md{--padding-block-start: var(--tcds-space-layout-md);padding-block-start:var(--padding-block-start)}.lg\\:layout-padding-block-end-md{--padding-block-end: var(--tcds-space-layout-md);padding-block-end:var(--padding-block-end)}.lg\\:layout-margin-block-md{--margin-block-start: var(--tcds-space-layout-md);--margin-block-end: var(--tcds-space-layout-md);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.lg\\:layout-margin-block-start-md{--margin-block-start: var(--tcds-space-layout-md);margin-block-start:var(--margin-block-start)}.lg\\:layout-margin-block-end-md{--margin-block-end: var(--tcds-space-layout-md);margin-block-end:var(--margin-block-end)}.lg\\:layout-padding-block-lg{--padding-block-start: var(--tcds-space-layout-lg);--padding-block-end: var(--tcds-space-layout-lg);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.lg\\:layout-padding-block-start-lg{--padding-block-start: var(--tcds-space-layout-lg);padding-block-start:var(--padding-block-start)}.lg\\:layout-padding-block-end-lg{--padding-block-end: var(--tcds-space-layout-lg);padding-block-end:var(--padding-block-end)}.lg\\:layout-margin-block-lg{--margin-block-start: var(--tcds-space-layout-lg);--margin-block-end: var(--tcds-space-layout-lg);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.lg\\:layout-margin-block-start-lg{--margin-block-start: var(--tcds-space-layout-lg);margin-block-start:var(--margin-block-start)}.lg\\:layout-margin-block-end-lg{--margin-block-end: var(--tcds-space-layout-lg);margin-block-end:var(--margin-block-end)}.lg\\:layout-padding-block-xl{--padding-block-start: var(--tcds-space-layout-xl);--padding-block-end: var(--tcds-space-layout-xl);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.lg\\:layout-padding-block-start-xl{--padding-block-start: var(--tcds-space-layout-xl);padding-block-start:var(--padding-block-start)}.lg\\:layout-padding-block-end-xl{--padding-block-end: var(--tcds-space-layout-xl);padding-block-end:var(--padding-block-end)}.lg\\:layout-margin-block-xl{--margin-block-start: var(--tcds-space-layout-xl);--margin-block-end: var(--tcds-space-layout-xl);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.lg\\:layout-margin-block-start-xl{--margin-block-start: var(--tcds-space-layout-xl);margin-block-start:var(--margin-block-start)}.lg\\:layout-margin-block-end-xl{--margin-block-end: var(--tcds-space-layout-xl);margin-block-end:var(--margin-block-end)}}@media(min-width: 1920px){.xl\\:component-padding-block-xs{--padding-block-start: var(--tcds-space-layout-xs);--padding-block-end: var(--tcds-space-layout-xs);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xl\\:component-padding-block-start-xs{--padding-block-start: var(--tcds-space-layout-xs);padding-block-start:var(--padding-block-start)}.xl\\:component-padding-block-end-xs{--padding-block-end: var(--tcds-space-layout-xs);padding-block-end:var(--padding-block-end)}.xl\\:component-margin-block-xs{--margin-block-start: var(--tcds-space-layout-xs);--margin-block-end: var(--tcds-space-layout-xs);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xl\\:component-margin-block-start-xs{--margin-block-start: var(--tcds-space-layout-xs);margin-block-start:var(--margin-block-start)}.xl\\:component-margin-block-end-xs{--margin-block-end: var(--tcds-space-layout-xs);margin-block-end:var(--margin-block-end)}.xl\\:component-padding-block-sm{--padding-block-start: var(--tcds-space-layout-sm);--padding-block-end: var(--tcds-space-layout-sm);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xl\\:component-padding-block-start-sm{--padding-block-start: var(--tcds-space-layout-sm);padding-block-start:var(--padding-block-start)}.xl\\:component-padding-block-end-sm{--padding-block-end: var(--tcds-space-layout-sm);padding-block-end:var(--padding-block-end)}.xl\\:component-margin-block-sm{--margin-block-start: var(--tcds-space-layout-sm);--margin-block-end: var(--tcds-space-layout-sm);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xl\\:component-margin-block-start-sm{--margin-block-start: var(--tcds-space-layout-sm);margin-block-start:var(--margin-block-start)}.xl\\:component-margin-block-end-sm{--margin-block-end: var(--tcds-space-layout-sm);margin-block-end:var(--margin-block-end)}.xl\\:component-padding-block-md{--padding-block-start: var(--tcds-space-layout-md);--padding-block-end: var(--tcds-space-layout-md);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xl\\:component-padding-block-start-md{--padding-block-start: var(--tcds-space-layout-md);padding-block-start:var(--padding-block-start)}.xl\\:component-padding-block-end-md{--padding-block-end: var(--tcds-space-layout-md);padding-block-end:var(--padding-block-end)}.xl\\:component-margin-block-md{--margin-block-start: var(--tcds-space-layout-md);--margin-block-end: var(--tcds-space-layout-md);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xl\\:component-margin-block-start-md{--margin-block-start: var(--tcds-space-layout-md);margin-block-start:var(--margin-block-start)}.xl\\:component-margin-block-end-md{--margin-block-end: var(--tcds-space-layout-md);margin-block-end:var(--margin-block-end)}.xl\\:component-padding-block-lg{--padding-block-start: var(--tcds-space-layout-lg);--padding-block-end: var(--tcds-space-layout-lg);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xl\\:component-padding-block-start-lg{--padding-block-start: var(--tcds-space-layout-lg);padding-block-start:var(--padding-block-start)}.xl\\:component-padding-block-end-lg{--padding-block-end: var(--tcds-space-layout-lg);padding-block-end:var(--padding-block-end)}.xl\\:component-margin-block-lg{--margin-block-start: var(--tcds-space-layout-lg);--margin-block-end: var(--tcds-space-layout-lg);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xl\\:component-margin-block-start-lg{--margin-block-start: var(--tcds-space-layout-lg);margin-block-start:var(--margin-block-start)}.xl\\:component-margin-block-end-lg{--margin-block-end: var(--tcds-space-layout-lg);margin-block-end:var(--margin-block-end)}.xl\\:component-padding-block-xl{--padding-block-start: var(--tcds-space-layout-xl);--padding-block-end: var(--tcds-space-layout-xl);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xl\\:component-padding-block-start-xl{--padding-block-start: var(--tcds-space-layout-xl);padding-block-start:var(--padding-block-start)}.xl\\:component-padding-block-end-xl{--padding-block-end: var(--tcds-space-layout-xl);padding-block-end:var(--padding-block-end)}.xl\\:component-margin-block-xl{--margin-block-start: var(--tcds-space-layout-xl);--margin-block-end: var(--tcds-space-layout-xl);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xl\\:component-margin-block-start-xl{--margin-block-start: var(--tcds-space-layout-xl);margin-block-start:var(--margin-block-start)}.xl\\:component-margin-block-end-xl{--margin-block-end: var(--tcds-space-layout-xl);margin-block-end:var(--margin-block-end)}.xl\\:layout-padding-block-xs{--padding-block-start: var(--tcds-space-layout-xs);--padding-block-end: var(--tcds-space-layout-xs);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xl\\:layout-padding-block-start-xs{--padding-block-start: var(--tcds-space-layout-xs);padding-block-start:var(--padding-block-start)}.xl\\:layout-padding-block-end-xs{--padding-block-end: var(--tcds-space-layout-xs);padding-block-end:var(--padding-block-end)}.xl\\:layout-margin-block-xs{--margin-block-start: var(--tcds-space-layout-xs);--margin-block-end: var(--tcds-space-layout-xs);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xl\\:layout-margin-block-start-xs{--margin-block-start: var(--tcds-space-layout-xs);margin-block-start:var(--margin-block-start)}.xl\\:layout-margin-block-end-xs{--margin-block-end: var(--tcds-space-layout-xs);margin-block-end:var(--margin-block-end)}.xl\\:layout-padding-block-sm{--padding-block-start: var(--tcds-space-layout-sm);--padding-block-end: var(--tcds-space-layout-sm);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xl\\:layout-padding-block-start-sm{--padding-block-start: var(--tcds-space-layout-sm);padding-block-start:var(--padding-block-start)}.xl\\:layout-padding-block-end-sm{--padding-block-end: var(--tcds-space-layout-sm);padding-block-end:var(--padding-block-end)}.xl\\:layout-margin-block-sm{--margin-block-start: var(--tcds-space-layout-sm);--margin-block-end: var(--tcds-space-layout-sm);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xl\\:layout-margin-block-start-sm{--margin-block-start: var(--tcds-space-layout-sm);margin-block-start:var(--margin-block-start)}.xl\\:layout-margin-block-end-sm{--margin-block-end: var(--tcds-space-layout-sm);margin-block-end:var(--margin-block-end)}.xl\\:layout-padding-block-md{--padding-block-start: var(--tcds-space-layout-md);--padding-block-end: var(--tcds-space-layout-md);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xl\\:layout-padding-block-start-md{--padding-block-start: var(--tcds-space-layout-md);padding-block-start:var(--padding-block-start)}.xl\\:layout-padding-block-end-md{--padding-block-end: var(--tcds-space-layout-md);padding-block-end:var(--padding-block-end)}.xl\\:layout-margin-block-md{--margin-block-start: var(--tcds-space-layout-md);--margin-block-end: var(--tcds-space-layout-md);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xl\\:layout-margin-block-start-md{--margin-block-start: var(--tcds-space-layout-md);margin-block-start:var(--margin-block-start)}.xl\\:layout-margin-block-end-md{--margin-block-end: var(--tcds-space-layout-md);margin-block-end:var(--margin-block-end)}.xl\\:layout-padding-block-lg{--padding-block-start: var(--tcds-space-layout-lg);--padding-block-end: var(--tcds-space-layout-lg);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xl\\:layout-padding-block-start-lg{--padding-block-start: var(--tcds-space-layout-lg);padding-block-start:var(--padding-block-start)}.xl\\:layout-padding-block-end-lg{--padding-block-end: var(--tcds-space-layout-lg);padding-block-end:var(--padding-block-end)}.xl\\:layout-margin-block-lg{--margin-block-start: var(--tcds-space-layout-lg);--margin-block-end: var(--tcds-space-layout-lg);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xl\\:layout-margin-block-start-lg{--margin-block-start: var(--tcds-space-layout-lg);margin-block-start:var(--margin-block-start)}.xl\\:layout-margin-block-end-lg{--margin-block-end: var(--tcds-space-layout-lg);margin-block-end:var(--margin-block-end)}.xl\\:layout-padding-block-xl{--padding-block-start: var(--tcds-space-layout-xl);--padding-block-end: var(--tcds-space-layout-xl);--padding-block: var(--padding-block-start) var(--padding-block-end);padding-block-start:var(--padding-block-start);padding-block-end:var(--padding-block-end)}.xl\\:layout-padding-block-start-xl{--padding-block-start: var(--tcds-space-layout-xl);padding-block-start:var(--padding-block-start)}.xl\\:layout-padding-block-end-xl{--padding-block-end: var(--tcds-space-layout-xl);padding-block-end:var(--padding-block-end)}.xl\\:layout-margin-block-xl{--margin-block-start: var(--tcds-space-layout-xl);--margin-block-end: var(--tcds-space-layout-xl);--margin-block: var(--margin-block-start) var(--margin-block-end);margin-block-start:var(--margin-block-start);margin-block-end:var(--margin-block-end)}.xl\\:layout-margin-block-start-xl{--margin-block-start: var(--tcds-space-layout-xl);margin-block-start:var(--margin-block-start)}.xl\\:layout-margin-block-end-xl{--margin-block-end: var(--tcds-space-layout-xl);margin-block-end:var(--margin-block-end)}}.margin-inline-auto{margin-inline:auto !important}.margin-inline-start-auto{margin-inline-start:auto !important}.margin-inline-end-auto{margin-inline-end:auto !important}@media(min-width: 320px){.xs\\:margin-inline-auto{margin-inline:auto !important}.xs\\:margin-inline-start-auto{margin-inline-start:auto !important}.xs\\:margin-inline-end-auto{margin-inline-end:auto !important}}@media(min-width: 640px){.sm\\:margin-inline-auto{margin-inline:auto !important}.sm\\:margin-inline-start-auto{margin-inline-start:auto !important}.sm\\:margin-inline-end-auto{margin-inline-end:auto !important}}@media(min-width: 960px){.md\\:margin-inline-auto{margin-inline:auto !important}.md\\:margin-inline-start-auto{margin-inline-start:auto !important}.md\\:margin-inline-end-auto{margin-inline-end:auto !important}}@media(min-width: 1312px){.lg\\:margin-inline-auto{margin-inline:auto !important}.lg\\:margin-inline-start-auto{margin-inline-start:auto !important}.lg\\:margin-inline-end-auto{margin-inline-end:auto !important}}@media(min-width: 1920px){.xl\\:margin-inline-auto{margin-inline:auto !important}.xl\\:margin-inline-start-auto{margin-inline-start:auto !important}.xl\\:margin-inline-end-auto{margin-inline-end:auto !important}}.text-display-1{font:700 3rem/1.06 Fraunces,serif !important}@media(width >= 960px){.text-display-1{font:700 8rem/1.06 Fraunces,serif !important}}.text-display-2{font:700 2.625rem/1.06 Fraunces,serif !important}@media(width >= 960px){.text-display-2{font:700 6rem/1.06 Fraunces,serif !important}}.text-heading-1{font:3rem/1.06 Fraunces,serif !important}@media(width >= 960px){.text-heading-1{font:4.5rem/1.06 Fraunces,serif !important}}.text-heading-2{font:2.625rem/1.06 Fraunces,serif !important}@media(width >= 960px){.text-heading-2{font:3.75rem/1.06 Fraunces,serif !important}}.text-heading-3{font:2.125rem/1.33 Fraunces,serif !important}@media(width >= 960px){.text-heading-3{font:3rem/1.06 Fraunces,serif !important}}.text-heading-4{font:1.25rem/1.33 Fraunces,serif !important}@media(width >= 960px){.text-heading-4{font:2.625rem/1.33 Fraunces,serif !important}}.text-body-lg{font:400 1.125rem/1.66 Poppins,system-ui,sans-serif !important}.text-body-md{font:400 1rem/1.66 Poppins,system-ui,sans-serif !important}.text-body-sm{font:400 .875rem/1.66 Poppins,system-ui,sans-serif !important}.text-body-xs{font:400 .75rem/1.66 Poppins,system-ui,sans-serif !important}.text-ui-lg{font:600 1.125rem/1.33 Poppins,system-ui,sans-serif !important}.text-ui-md{font:600 1rem/1.33 Poppins,system-ui,sans-serif !important}.text-ui-sm{font:600 .875rem/1.33 Poppins,system-ui,sans-serif !important}.font-family-display{font-family:var(--tcds-font-family-display) !important;font-weight:var(--tcds-font-weight-display)}.font-family-body{font-family:var(--tcds-font-family-body) !important;font-weight:var(--tcds-font-weight-body)}.font-family-ui{font-family:var(--tcds-font-family-ui) !important;font-weight:var(--tcds-font-weight-ui)}.font-family-sans-serif{font-family:var(--tcds-font-stack-sans-serif) !important}.font-family-serif{font-family:var(--tcds-font-stack-serif) !important}.text-align-center{text-align:center !important}.text-align-left,.text-align-inline-start{text-align:inline-start !important}@media(min-width: 320px){.xs\\:text-align-center{text-align:center !important}.xs\\:text-align-left,.xs\\:text-align-inline-start{text-align:inline-start !important}}@media(min-width: 640px){.sm\\:text-align-center{text-align:center !important}.sm\\:text-align-left,.sm\\:text-align-inline-start{text-align:inline-start !important}}@media(min-width: 960px){.md\\:text-align-center{text-align:center !important}.md\\:text-align-left,.md\\:text-align-inline-start{text-align:inline-start !important}}@media(min-width: 1312px){.lg\\:text-align-center{text-align:center !important}.lg\\:text-align-left,.lg\\:text-align-inline-start{text-align:inline-start !important}}@media(min-width: 1920px){.xl\\:text-align-center{text-align:center !important}.xl\\:text-align-left,.xl\\:text-align-inline-start{text-align:inline-start !important}}.font-variant-tabular-nums{font-variant-numeric:lining-nums tabular-nums !important}.white-space-nowrap{white-space:nowrap}@layer tcds-components{.tcds-button{--tcds-button-background-color: var(--tcds-color-theme-accent);--tcds-button-background-color-hover: color-mix(in oklab, var(--tcds-color-theme-accent), rgb(0 0 0) 10%);--tcds-button-text-color: var(--tcds-color-theme-accent-text-primary);--tcds-button-text-color-hover: var(--tcds-color-theme-accent-text-primary);--tcds-button-padding: 0 2rem;--tcds-button-font-size: var(--tcds-font-size-md);--tcds-button-height: var(--tcds-size-component-lg);--tcds-button-width: auto;background-color:var(--tcds-button-background-color);border:var(--tcds-button-border-width, 2px) solid var(--tcds-button-border-color, var(--tcds-button-background-color));color:var(--tcds-button-text-color);cursor:pointer;font-weight:var(--tcds-font-weight-ui);font-size:var(--tcds-button-font-size);padding:var(--tcds-button-padding);height:var(--tcds-button-height);width:var(--tcds-button-width);border-radius:var(--tcds-button-height);display:inline-flex;gap:.75rem;align-items:center;justify-content:center;text-align:center;text-decoration:none;line-height:1;transition:background-color var(--tcds-motion-duration-productive) var(--tcds-motion-easing-translate),border-color var(--tcds-motion-duration-productive) var(--tcds-motion-easing-translate),color var(--tcds-motion-duration-productive) var(--tcds-motion-easing-translate)}.tcds-button:hover,.tcds-button:active,[data-pointer-event-proxy=".tcds-cta-link"]:hover .tcds-button,[data-pointer-event-proxy=".tcds-button"]:hover .tcds-button{background-color:var(--tcds-button-background-color-hover);color:var(--tcds-button-text-color-hover);border-color:var(--tcds-button-border-color-hover)}.tcds-button:active{background-color:var(--tcds-button-background-color-active, var(--tcds-button-background-color-hover));color:var(--tcds-button-text-color-active, var(--tcds-button-text-color-hover));border-color:var(--tcds-button-border-color-active, var(--tcds-button-border-color-hover))}.tcds-button tcds-icon,.tcds-button:is(tcds-icon){font-size:var(--tcds-button-icon-size, 0.66em)}.tcds-button:is(tcds-icon){--tcds-button-padding: 0 ;--tcds-button-width: var(--tcds-button-height) }.tcds-button--reverse{--tcds-button-background-color: var(--tcds-color-theme-accent-text-primary);--tcds-button-text-color: var(--tcds-color-theme-accent);--tcds-button-background-color-hover: var(--tcds-color-theme-accent);--tcds-button-text-color-hover: var(--tcds-color-palette-white);--tcds-button-border-color-hover: var(--tcds-color-theme-accent)}.tcds-button--large{--tcds-button-padding: 0 2.5rem;--tcds-button-height: var(--tcds-size-component-xl);--tcds-button-font-size: var(--tcds-font-size-lg);--tcds-button-icon-size: 1.85em}.tcds-button--media{--tcds-button-background-color: transparent;--tcds-button-background-color-hover: transparent;--tcds-button-text-color: var(--tcds-color-theme-default-accent);--tcds-button-text-color-hover: color-mix(in oklab, var(--tcds-color-theme-default-accent), rgb(0 0 0) 10%);--tcds-button-text-color-active: var(--tcds-button-text-color-hover);--tcds-button-border-color: var(--tcds-color-theme-default-accent);--tcds-button-border-color-hover: color-mix(in oklab, var(--tcds-color-theme-default-accent), rgb(0 0 0) 10%);--tcds-button-border-width: 1.5px;--tcds-button-height: var(--tcds-size-component-sm);--tcds-button-width: var(--tcds-button-height);--tcds-button-padding: 0}}.tcds-cta-link{--tcds-button-background-color: var(--tcds-color-theme-accent);--tcds-button-background-color-hover: color-mix(in oklab, var(--tcds-color-theme-accent), rgb(0 0 0) 10%);--tcds-button-text-color: var(--tcds-color-theme-accent-text-primary);--tcds-button-text-color-hover: var(--tcds-color-theme-accent-text-primary);--tcds-button-padding: 0 2rem;--tcds-button-font-size: var(--tcds-font-size-md);--tcds-button-height: var(--tcds-size-component-lg);--tcds-button-width: auto;background-color:var(--tcds-button-background-color) !important;border:var(--tcds-button-border-width, 2px) solid var(--tcds-button-border-color, var(--tcds-button-background-color)) !important;color:var(--tcds-button-text-color) !important;cursor:pointer;font-weight:var(--tcds-font-weight-ui) !important;font-size:var(--tcds-button-font-size) !important;padding:var(--tcds-button-padding) !important;height:var(--tcds-button-height) !important;width:var(--tcds-button-width) !important;border-radius:var(--tcds-button-height) !important;display:inline-flex !important;gap:.75rem !important;align-items:center !important;justify-content:center !important;text-align:center !important;text-decoration:none !important;line-height:1 !important;transition:background-color var(--tcds-motion-duration-productive) var(--tcds-motion-easing-translate),border-color var(--tcds-motion-duration-productive) var(--tcds-motion-easing-translate),color var(--tcds-motion-duration-productive) var(--tcds-motion-easing-translate) !important}.tcds-cta-link:hover,.tcds-cta-link:active,[data-pointer-event-proxy=".tcds-cta-link"]:hover .tcds-cta-link,[data-pointer-event-proxy=".tcds-button"]:hover .tcds-cta-link{background-color:var(--tcds-button-background-color-hover);color:var(--tcds-button-text-color-hover);border-color:var(--tcds-button-border-color-hover)}.tcds-cta-link:active{background-color:var(--tcds-button-background-color-active, var(--tcds-button-background-color-hover));color:var(--tcds-button-text-color-active, var(--tcds-button-text-color-hover));border-color:var(--tcds-button-border-color-active, var(--tcds-button-border-color-hover))}.tcds-cta-link tcds-icon,.tcds-cta-link:is(tcds-icon){font-size:var(--tcds-button-icon-size, 0.66em) !important}.tcds-cta-link:is(tcds-icon){--tcds-button-padding: 0 !important;--tcds-button-width: var(--tcds-button-height) !important}.tcds-cta-link--outline{--tcds-button-background-color: transparent;--tcds-button-text-color: var(--tcds-color-theme-accent);--tcds-button-border-color: var(--tcds-color-theme-accent);--tcds-button-border-color-hover: var(--tcds-button-background-color)}/*# sourceMappingURL=shared.css.map */
`;
...
export { Disclosure as D, SizeBreakpointMd as S, DisclosureGroup as a, prepareMedia as b, pauseMedia as p, restoreMedia as r, styles as s };
